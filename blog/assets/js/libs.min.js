/*! jQuery v1.11.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ ! function(e, t) {
    ...
    p.fn = p.prototype = {
        ...
        var e, t, i, n, s, a, r = arguments[0] || {},
            ...
            l = arguments.length,
            c = !1;
        for ("boolean" == typeof r && (c = r, r = arguments[o] || {}, o++), "object" == typeof r || p.isFunction(r) || (r = {}), o === l && (r = this, o--); l > o; o++)
            if (null != (s = arguments[o]))
                for (n in s) e = r[n], r !== (i = s[n]) && (c && i && (p.isPlainObject(i) || (t = p.isArray(i))) ? (t ? (t = !1, a = e && p.isArray(e) ? e : []) : a = e && p.isPlainObject(e) ? e : {}, r[n] = p.extend(c, a, i)) : void 0 !== i && (r[n] = i));
        return r
    }, p.extend({
        ...
        makeArray: function(e, t) {
            var i = t || [];
            return null != e && (y(Object(e)) ? p.merge(i, "string" == typeof e ? [e] : e) : a.call(i, e)), i
        },
        ...
        grep: function(e, t, i) {
            for (var n = [], s = 0, a = e.length, r = !i; a > s; s++) !t(e[s], s) !== r && n.push(e[s]);
            return n
        },
        map: function(e, t, i) {
            var n, a = 0,
                ...
                o = [];
            if (y(e))
                for (; r > a; a++) null != (n = t(e[a], a, i)) && o.push(n);
            else
        ...
        proxy: function(e, t) {
            var i, s, a;
            return "string" == typeof t && (a = e[t], t = e, e = a), p.isFunction(e) ? (i = n.call(arguments, 2), (s = function() {
    ...
    var b = function(e) {
        var t, i, n, s, a, r, o, l, c, d, u, h, p, f, m, g, v, y = "sizzle" + -new Date,
            b = e.document,
            w = 0,
            x = 0,
            T = ne(),
        ...
        try {
            I.apply(M = L.call(b.childNodes), b.childNodes), M[b.childNodes.length].nodeType
        } catch (e) {
            I = {
        ...
        function ie(e, t, n, s) {
            var a, r, o, l, c, h, m, g, w, x;
            if ((t ? t.ownerDocument || t : b) !== u && d(t), n = n || [], !e || "string" != typeof e) return n;
            if (1 !== (l = (t = t || u).nodeType) && 9 !== l) return [];
            if (p && !s) {
                if (a = Q.exec(e))
                    if (o = a[1]) {
                        if (9 === l) {
                        ...
                        if (a[2]) return I.apply(n, t.getElementsByTagName(e)), n;
                        if ((o = a[3]) && i.getElementsByClassName && t.getElementsByClassName) return I.apply(n, t.getElementsByClassName(o)), n
                    }
                if (i.qsa && (!f || !f.test(e))) {
                    if (g = m = y, w = t, x = 9 === l && e, 1 === l && "object" !== t.nodeName.toLowerCase()) {
                        for (h = pe(e), (m = t.getAttribute("id")) ? g = m.replace(J, "\\$&") : t.setAttribute("id", g), g = "[id='" + g + "'] ", c = h.length; c--;) h[c] = g + fe(h[c]);
                        w = Z.test(e) && ue(t.parentNode) || t, x = h.join(",")
                    }
                    if (x) try {
                        return I.apply(n, w.querySelectorAll(x)), n
                    } catch (e) {} finally {
                        m || t.removeAttribute("id")
                    }
                }
            }
            return xe(e.replace(B, "$1"), t, n, s)
        }
        ...
        for (t in i = ie.support = {}, a = ie.isXML = function(e) {
                var t = e && (e.ownerDocument || e).documentElement;
                return !!t && "HTML" !== t.nodeName
            }, d = ie.setDocument = function(e) {
                var t, s = e ? e.ownerDocument || e : b,
                    r = s.defaultView;
                return s !== u && 9 === s.nodeType && s.documentElement ? (u = s, h = s.documentElement, p = !a(s), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", (function() {
                    d()
                ...
                })), i.getElementsByClassName = K.test(s.getElementsByClassName) && ae((function(e) {
                    return e.innerHTML = "<div class='a'></div><div class='a i'></div>", e.firstChild.className = "i", 2 === e.getElementsByClassName("i").length
                })), i.getById = ae((function(e) {
                    return h.appendChild(e).id = y, !s.getElementsByName || !s.getElementsByName(y).length
                })), i.getById ? (n.find.ID = function(e, t) {
                    if (typeof t.getElementById !== _ && p) {
                    ...
                    var t = e.replace(ee, te);
                    return function(e) {
                        var i = typeof e.getAttributeNode !== _ && e.getAttributeNode("id");
                        return i && i.value === t
                    }
                    ...
                    return typeof t.getElementsByClassName !== _ && p ? t.getElementsByClassName(e) : void 0
                }, m = [], f = [], (i.qsa = K.test(s.querySelectorAll)) && (ae((function(e) {
                    e.innerHTML = "<select t=''><option selected=''></option></select>", e.querySelectorAll("[t^='']").length && f.push("[*^$]=" + O + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || f.push("\\[" + O + "*(?:value|" + N + ")"), e.querySelectorAll(":checked").length || f.push(":checked")
                })), ae((function(e) {
                    var t = s.createElement("input");
                    t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && f.push("name" + O + "*[*^$|!~]?="), e.querySelectorAll(":enabled").length || f.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), f.push(",.*:")
                }))), (i.matchesSelector = K.test(g = h.webkitMatchesSelector || h.mozMatchesSelector || h.oMatchesSelector || h.msMatchesSelector)) && ae((function(e) {
                    i.disconnectedMatch = g.call(e, "div"), g.call(e, "[s!='']:x"), m.push("!=", F)
                })), f = f.length && new RegExp(f.join("|")), m = m.length && new RegExp(m.join("|")), t = K.test(h.compareDocumentPosition), v = t || K.test(h.contains) ? function(e, t) {
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !i.sortDetached && t.compareDocumentPosition(e) === n ? e === s || e.ownerDocument === b && v(b, e) ? -1 : t === s || t.ownerDocument === b && v(b, t) ? 1 : l ? $.call(l, e) - $.call(l, t) : 0 : 4 & n ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return c = !0, 0;
                    var i, n = 0,
                        a = e.parentNode,
                        ...
                        o = [e],
                        d = [t];
                    if (!a || !r) return e === s ? -1 : t === s ? 1 : a ? -1 : r ? 1 : l ? $.call(l, e) - $.call(l, t) : 0;
                    if (a === r) return oe(e, t);
                    for (i = e; i = i.parentNode;) o.unshift(i);
                    for (i = t; i = i.parentNode;) d.unshift(i);
                    for (; o[n] === d[n];) n++;
                    return n ? oe(o[n], d[n]) : o[n] === b ? -1 : d[n] === b ? 1 : 0
                }, s) : u
            }, ie.matches = function(e, t) {
                return ie(e, null, null, t)
            }, ie.matchesSelector = function(e, t) {
                if ((e.ownerDocument || e) !== u && d(e), t = t.replace(W, "='$1']"), !(!i.matchesSelector || !p || m && m.test(t) || f && f.test(t))) try {
                    var n = g.call(e, t);
                    if (n || i.disconnectedMatch || e.document && 11 !== e.document.nodeType) return n
                } catch (e) {}
                return ie(t, u, null, [e]).length > 0
            }, ie.contains = function(e, t) {
                return (e.ownerDocument || e) !== u && d(e), v(e, t)
            }, ie.attr = function(e, t) {
                (e.ownerDocument || e) !== u && d(e);
                var s = n.attrHandle[t.toLowerCase()],
                    a = s && P.call(n.attrHandle, t.toLowerCase()) ? s(e, t, !p) : void 0;
                return void 0 !== a ? a : i.attributes || !p ? e.getAttribute(t) : (a = e.getAttributeNode(t)) && a.specified ? a.value : null
            }, ie.error = function(e) {
                ...
                var t, n = [],
                    s = 0,
                    a = 0;
                if (c = !i.detectDuplicates, l = !i.sortStable && e.slice(0), e.sort(S), c) {
                ...
                preFilter: {
                    ...
                    PSEUDO: function(e) {
                        var t, i = !e[5] && e[2];
                        return V.CHILD.test(e[0]) ? null : (e[3] && void 0 !== e[4] ? e[2] = e[4] : i && X.test(i) && (t = pe(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && (e[0] = e[0].slice(0, t), e[2] = i.slice(0, t)), e.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(e) {
                    ...
                    CHILD: function(e, t, i, n, s) {
                        ...
                        return 1 === n && 0 === s ? function(e) {
                            ...
                            if (g) {
                                ...
                                } else if (b && (c = (t[y] || (t[y] = {}))[e]) && c[0] === w) h = c[1];
                                else
                                    for (;
                                        (u = ++p && u && u[m] || (h = p = 0) || f.pop()) && ((o ? u.nodeName.toLowerCase() !== v : 1 !== u.nodeType) || !++h || (b && ((u[y] || (u[y] = {}))[e] = [w, h]), u !== t)););
                                return (h -= s) === n || h % n == 0 && h / n >= 0
                            }
                        }
                    },
                    PSEUDO: function(e, t) {
                        var i, s = n.pseudos[e] || n.setFilters[e.toLowerCase()] || ie.error("unsupported pseudo: " + e);
                        return s[y] ? s(t) : s.length > 1 ? (i = [e, e, "", t], n.setFilters.hasOwnProperty(e.toLowerCase()) ? se((function(e, i) {
                            for (var n, a = s(e, t), r = a.length; r--;) e[n = $.call(e, a[r])] = !(i[n] = a[r])
                        })) : function(e) {
                            return s(e, 0, i)
                        }) : s
                    }
                ...
                pseudos: {
                    not: se((function(e) {
                        var t = [],
                            i = [],
                            n = r(e.replace(B, "$1"));
                        return n[y] ? se((function(e, t, i, s) {
                    ...
                    lang: se((function(e) {
                        return Y.test(e || "") || ie.error("unsupported lang: " + e), e = e.replace(ee, te).toLowerCase(),
                            function(t) {
                                var i;
                                do {
        ...
        function pe(e, t) {
            ...
            for (o = e, l = [], c = n.preFilter; o;) {
                for (r in (!i || (s = R.exec(o))) && (s && (o = o.slice(s[0].length) || o), l.push(a = [])), i = !1, (s = q.exec(o)) && (i = s.shift(), a.push({
                        value: i,
                        type: s[0].replace(B, " ")
                    }), o = o.slice(i.length)), n.filter) !(s = V[r].exec(o)) || c[r] && !(s = c[r](s)) || (i = s.shift(), a.push({
                    value: i,
                    type: r,
                    matches: s
                }), o = o.slice(i.length));
            ...
            return t ? o.length : o ? ie.error(e) : E(e, l).slice(0)
        }
        ...
        function me(e, t, i) {
            ...
            return t.first ? function(t, i, a) {
                ...
                if (r) {
                    ...
                    for (; t = t[n];)
                        if (1 === t.nodeType || s) {
                            if ((o = (l = t[y] || (t[y] = {}))[n]) && o[0] === w && o[1] === a) return c[2] = o[2];
        ...
        function ye(e, t, i, n, s, a) {
            return n && !n[y] && (n = ye(n)), s && !s[y] && (s = ye(s, a)), se((function(a, r, o, l) {
                var c, d, u, h = [],
                    p = [],
                    f = r.length,
                    m = a || function(e, t, i) {
                        for (var n = 0, s = t.length; s > n; n++) ie(e, t[n], i);
                        return i
                    }(t || "*", o.nodeType ? [o] : o, []),
                    g = !e || !a && t ? m : ve(m, h, e, o, l),
                    v = i ? s || (a ? e : f || n) ? [] : r : g;
                if (i && i(g, v, o, l), n)
                    for (c = ve(v, p), n(c, [], o, l), d = c.length; d--;)(u = c[d]) && (v[p[d]] = !(g[p[d]] = u));
                if (a) {
                    if (s || e) {
                        if (s) {
                        ...
                        for (d = v.length; d--;)(u = v[d]) && (c = s ? $.call(a, u) : h[d]) > -1 && (a[c] = !(r[c] = u))
                    }
                } else v = ve(v === r ? v.splice(f, v.length) : v), s ? s(null, r, v, l) : I.apply(r, v)
            }))
        }

        function be(e) {
            for (var t, i, s, a = e.length, r = n.relative[e[0].type], l = r || n.relative[" "], c = r ? 1 : 0, d = me((function(e) {
                    return e === t
                }), l, !0), u = me((function(e) {
                    return $.call(t, e) > -1
                }), l, !0), h = [function(e, i, n) {
                    return !r && (n || i !== o) || ((t = i).nodeType ? d(e, i, n) : u(e, i, n))
                }]; a > c; c++)
                if (i = n.relative[e[c].type]) h = [me(ge(h), i)];
                else {
                    if ((i = n.filter[e[c].type].apply(null, e[c].matches))[y]) {
                        for (s = ++c; a > s && !n.relative[e[s].type]; s++);
                        return ye(c > 1 && ge(h), c > 1 && fe(e.slice(0, c - 1).concat({
                            value: " " === e[c - 2].type ? "*" : ""
                        })).replace(B, "$1"), i, s > c && be(e.slice(c, s)), a > s && be(e = e.slice(s)), a > s && fe(e))
                    }
                    h.push(i)
                }
            return ge(h)
            ...
            var i = t.length > 0,
                ...
                a = function(a, r, l, c, d) {
                    var h, p, f, m = 0,
                        ...
                        E = x.length;
                    for (d && (o = r !== u && r); g !== E && null != (h = x[g]); g++) {
                        if (s && h) {
                            for (p = 0; f = e[p++];)
                                if (f(h, r, l)) {
                                    c.push(h);
                        ...
                        i && ((h = !f && h) && m--, a && v.push(h))
                    }
                    if (m += g, i && g !== m) {
                        for (p = 0; f = t[p++];) f(v, y, r, l);
                        if (a) {
                            if (m > 0)
                                for (; g--;) v[g] || y[g] || (y[g] = D.call(c));
                            y = ve(y)
                        }
                        I.apply(c, y), d && !a && y.length > 0 && m + t.length > 1 && ie.uniqueSort(c)
                    }
                    return d && (w = T, o = b), v
                };
            return i ? se(a) : a
        ...
        function xe(e, t, s, a) {
            var o, l, c, d, u, h = pe(e);
            if (!a && 1 === h.length) {
                if ((l = h[0] = h[0].slice(0)).length > 2 && "ID" === (c = l[0]).type && i.getById && 9 === t.nodeType && p && n.relative[l[1].type]) {
                    if (!(t = (n.find.ID(c.matches[0].replace(ee, te), t) || [])[0])) return s;
                    e = e.slice(l.shift().value.length)
                }
                for (o = V.needsContext.test(e) ? 0 : l.length; o-- && (c = l[o], !n.relative[d = c.type]);)
                    if ((u = n.find[d]) && (a = u(c.matches[0].replace(ee, te), Z.test(l[0].type) && ue(t.parentNode) || t))) {
                        if (l.splice(o, 1), !(e = a.length && fe(l))) return I.apply(s, a), s;
                        break
                    }
            }
            return r(e, h)(a, t, !p, s, Z.test(e) && ue(t.parentNode) || t), s
        }
        return he.prototype = n.filters = n.pseudos, n.setFilters = new he, r = ie.compile = function(e, t) {
            var i, n = [],
                s = [],
                a = C[e + " "];
            if (!a) {
                for (t || (t = pe(e)), i = t.length; i--;)(a = be(t[i]))[y] ? n.push(a) : s.push(a);
                a = C(e, we(s, n))
            }
            return a
        }, i.sortStable = y.split("").sort(S).join("") === y, i.detectDuplicates = !!c, d(), i.sortDetached = ae((function(e) {
    ...
    p.filter = function(e, t, i) {
        ...
        find: function(e) {
            ...
            for (t = 0; s > t; t++) p.find(e, n[t], i);
            return (i = this.pushStack(s > 1 ? p.unique(i) : i)).selector = this.selector ? this.selector + " " + e : e, i
        },
        filter: function(e) {
        ...
        is: function(e) {
            return !!E(this, "string" == typeof e && w.test(e) ? p(e) : e || [], !1).length
        }
    });
    var C, S = e.document,
        _ = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    (p.fn.init = function(e, t) {
        ...
        if (!e) return this;
        if ("string" == typeof e) {
            if (!(i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : _.exec(e)) || !i[1] && t) return !t || t.jquery ? (t || C).find(e) : this.constructor(t).find(e);
            if (i[1]) {
                if (t = t instanceof p ? t[0] : t, p.merge(this, p.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : S, !0)), x.test(i[1]) && p.isPlainObject(t))
                    for (i in t) p.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this
            }
            if ((n = S.getElementById(i[2])) && n.parentNode) {
                if (n.id !== i[2]) return C.find(e);
                this.length = 1, this[0] = n
            }
            return this.context = S, this.selector = e, this
        }
        return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : p.isFunction(e) ? void 0 !== C.ready ? C.ready(e) : e(p) : (void 0 !== e.selector && (this.selector = e.selector, this.context = e.context), p.makeArray(e, this))
    }).prototype = p.fn, C = p(S);
    ...
    p.extend({
        ...
        closest: function(e, t) {
            for (var i, n = 0, s = this.length, a = [], r = w.test(e) || "string" != typeof e ? p(e, t || this.context) : 0; s > n; n++)
                for (i = this[n]; i && i !== t; i = i.parentNode)
                    if (i.nodeType < 11 && (r ? r.index(i) > -1 : 1 === i.nodeType && p.find.matchesSelector(i, e))) {
                        a.push(i);
                        break
                    }
        ...
        p.fn[e] = function(i, n) {
            ...
            return "Until" !== e.slice(-5) && (n = i), n && "string" == typeof n && (s = p.filter(n, s)), this.length > 1 && (P[e] || (s = p.unique(s)), k.test(e) && (s = s.reverse())), this.pushStack(s)
        }
    }));
    var D, A = /\S+/g,
        I = {};
    ...
    function L() {
        S.addEventListener ? (S.removeEventListener("DOMContentLoaded", $, !1), e.removeEventListener("load", $, !1)) : (S.detachEvent("onreadystatechange", $), e.detachEvent("onload", $))
    }

    function $() {
        (S.addEventListener || "load" === event.type || "complete" === S.readyState) && (L(), p.ready())
    }
    p.Callbacks = function(e) {
        e = "string" == typeof e ? I[e] || function(e) {
            var t = I[e] = {};
            return p.each(e.match(A) || [], (function(e, i) {
                t[i] = !0
            })), t
        }(e) : p.extend({}, e);
        var t, i, n, s, a, r, o = [],
            l = !e.once && [],
            c = function(u) {
                for (i = e.memory && u, n = !0, a = r || 0, r = 0, s = o.length, t = !0; o && s > a; a++)
                    if (!1 === o[a].apply(u[0], u[1]) && e.stopOnFalse) {
                        i = !1;
                        break
                    }
                t = !1, o && (l ? l.length && c(l.shift()) : i ? o = [] : d.disable())
            },
            d = {
                add: function() {
                    if (o) {
                        ...
                        ! function t(i) {
                            p.each(i, (function(i, n) {
                                var s = p.type(n);
                                "function" === s ? e.unique && d.has(n) || o.push(n) : n && n.length && "string" !== s && t(n)
                            }))
                        }(arguments), t ? s = o.length : i && (r = n, c(i))
                    }
                    return this
                },
                remove: function() {
                    return o && p.each(arguments, (function(e, i) {
                        for (var n;
                            (n = p.inArray(i, o, n)) > -1;) o.splice(n, 1), t && (s >= n && s--, a >= n && a--)
                    })), this
                },
                has: function(e) {
                ...
                fireWith: function(e, i) {
                    return !o || n && !l || (i = [e, (i = i || []).slice ? i.slice() : i], t ? l.push(i) : c(i)), this
                },
                fire: function() {
        ...
        Deferred: function(e) {
            var t = [
                        ...
                        return p.Deferred((function(i) {
                            p.each(t, (function(t, a) {
                                ...
                                s[a[1]]((function() {
                                    ...
                                    e && p.isFunction(e.promise) ? e.promise().done(i.resolve).fail(i.reject).progress(i.notify) : i[a[0] + "With"](this === n ? i.promise() : this, r ? [e] : arguments)
                                }))
                            })), e = null
                        })).promise()
                    },
                ...
                s = {};
            return n.pipe = n.then, p.each(t, (function(e, a) {
                var r = a[2],
                    o = a[3];
        ...
        when: function(e) {
            var t, i, s, a = 0,
                ...
                d = function(e, i, s) {
                    return function(a) {
                        i[e] = this, s[e] = arguments.length > 1 ? n.call(arguments) : a, s === t ? c.notifyWith(i, s) : --l || c.resolveWith(i, s)
                    }
                };
            if (o > 1)
                for (t = new Array(o), i = new Array(o), s = new Array(o); o > a; a++) r[a] && p.isFunction(r[a].promise) ? r[a].promise().done(d(a, s, r)).fail(c.reject).progress(d(a, i, t)) : --l;
        ...
        ready: function(e) {
            if (!0 === e ? !--p.readyWait : !p.isReady) {
                ...
                p.isReady = !0, !0 !== e && --p.readyWait > 0 || (D.resolveWith(S, [p]), p.fn.trigger && p(S).trigger("ready").off("ready"))
            }
        }
    }), p.ready.promise = function(t) {
        if (!D)
            if (D = p.Deferred(), "complete" === S.readyState) setTimeout(p.ready);
            else if (S.addEventListener) S.addEventListener("DOMContentLoaded", $, !1), e.addEventListener("load", $, !1);
        else {
            S.attachEvent("onreadystatechange", $), e.attachEvent("onload", $);
            var i = !1;
            try {
    ...
    var N, O = "undefined";
    for (N in p(u)) break;
    u.ownLast = "0" !== N, u.inlineBlockNeedsLayout = !1, p((function() {
            var e, t, i = S.getElementsByTagName("body")[0];
            i && ((e = S.createElement("div")).style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", t = S.createElement("div"), i.appendChild(e).appendChild(t), typeof t.style.zoom !== O && (t.style.cssText = "border:0;margin:0;width:1px;padding:1px;display:inline;zoom:1", (u.inlineBlockNeedsLayout = 3 === t.offsetWidth) && (i.style.zoom = 1)), i.removeChild(e), e = t = null)
        })),
        function() {
    ...
    function B(e, t, n, s) {
        if (p.acceptData(e)) {
            var a, r, o = p.expando,
                ...
                c = l ? p.cache : e,
                d = l ? e[o] : e[o] && o;
            if (d && c[d] && (s || c[d].data) || void 0 !== n || "string" != typeof t) return d || (d = l ? e[o] = i.pop() || p.guid++ : o), c[d] || (c[d] = l ? {} : {
                toJSON: p.noop
            }), ("object" == typeof t || "function" == typeof t) && (s ? c[d] = p.extend(c[d], t) : c[d].data = p.extend(c[d].data, t)), r = c[d], s || (r.data || (r.data = {}), r = r.data), void 0 !== n && (r[p.camelCase(t)] = n), "string" == typeof t ? null == (a = r[t]) && (a = r[p.camelCase(t)]) : a = r, a
        }
    }
        ...
        if (p.acceptData(e)) {
            ...
            if (r[o]) {
                if (t && (n = i ? r[o] : r[o].data)) {
                    p.isArray(t) ? t = t.concat(p.map(t, p.camelCase)) : t in n ? t = [t] : t = (t = p.camelCase(t)) in n ? [t] : t.split(" "), s = t.length;
                    for (; s--;) delete n[t[s]];
                    if (i ? !F(n) : !p.isEmptyObject(n)) return
                }(i || (delete r[o].data, F(r[o]))) && (a ? p.cleanData([e], !0) : u.deleteExpando || r != r.window ? delete r[o] : r[o] = null)
            }
        }
    }
    p.extend({
        ...
        data: function(e, t) {
            var i, n, s, a = this[0],
                r = a && a.attributes;
            if (void 0 === e) {
                if (this.length && (s = p.data(a), 1 === a.nodeType && !p._data(a, "parsedAttrs"))) {
                    for (i = r.length; i--;) 0 === (n = r[i].name).indexOf("data-") && j(a, n = p.camelCase(n.slice(5)), s[n]);
        ...
        promise: function(e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; r--;)(i = p._data(a[r], e + "queueHooks")) && i.empty && (n++, i.empty.add(o));
    ...
    var q = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        Y = p.access = function(e, t, i, n, s, a, r) {
            var o = 0,
                l = e.length,
                c = null == i;
            if ("object" === p.type(i))
                for (o in s = !0, i) p.access(e, t, o, i[o], !0, a, r);
            else if (void 0 !== n && (s = !0, p.isFunction(n) || (r = !0), c && (r ? (t.call(e, n), t = null) : (c = t, t = function(e, t, i) {
                    return c.call(p(e), i)
                })), t))
    ...
    ! function() {
        ...
        if (t.setAttribute("className", "t"), t.innerHTML = "  <link/><table></table><a href='/a'>a</a>", u.leadingWhitespace = 3 === t.firstChild.nodeType, u.tbody = !t.getElementsByTagName("tbody").length, u.htmlSerialize = !!t.getElementsByTagName("link").length, u.html5Clone = "<:nav></:nav>" !== S.createElement("nav").cloneNode(!0).outerHTML, i.type = "checkbox", i.checked = !0, e.appendChild(i), u.appendChecked = i.checked, t.innerHTML = "<textarea>x</textarea>", u.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue, e.appendChild(t), t.innerHTML = "<input type='radio' checked='checked' name='t'/>", u.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, u.noCloneEvent = !0, t.attachEvent && (t.attachEvent("onclick", (function() {
                u.noCloneEvent = !1
    ...
    function() {
        ...
        for (t in {
                ...
                change: !0,
                focusin: !0
            }) i = "on" + t, (u[t + "Bubbles"] = i in e) || (n.setAttribute(i, "t"), u[t + "Bubbles"] = !1 === n.attributes[i].expando);
        n = null
    }();
    ...
    p.event = {
        ...
        add: function(e, t, i, n, s) {
            var a, r, o, l, c, d, u, h, f, m, g, v = p._data(e);
            if (v) {
                for (i.handler && (i = (l = i).handler, s = l.selector), i.guid || (i.guid = p.guid++), (r = v.events) || (r = v.events = {}), (d = v.handle) || ((d = v.handle = function(e) {
                        return typeof p === O || e && p.event.triggered === e.type ? void 0 : p.event.dispatch.apply(d.elem, arguments)
                    }).elem = e), o = (t = (t || "").match(A) || [""]).length; o--;) f = g = (a = Z.exec(t[o]) || [])[1], m = (a[2] || "").split(".").sort(), f && (c = p.event.special[f] || {}, f = (s ? c.delegateType : c.bindType) || f, c = p.event.special[f] || {}, u = p.extend({
                    type: f,
                    origType: g,
                    data: n,
                    handler: i,
                    ...
                    namespace: m.join(".")
                }, l), (h = r[f]) || ((h = r[f] = []).delegateCount = 0, c.setup && !1 !== c.setup.call(e, n, m, d) || (e.addEventListener ? e.addEventListener(f, d, !1) : e.attachEvent && e.attachEvent("on" + f, d))), c.add && (c.add.call(e, u), u.handler.guid || (u.handler.guid = i.guid)), s ? h.splice(h.delegateCount++, 0, u) : h.push(u), p.event.global[f] = !0);
                e = null
            }
        },
        remove: function(e, t, i, n, s) {
            var a, r, o, l, c, d, u, h, f, m, g, v = p.hasData(e) && p._data(e);
            if (v && (d = v.events)) {
                for (c = (t = (t || "").match(A) || [""]).length; c--;)
                    if (f = g = (o = Z.exec(t[c]) || [])[1], m = (o[2] || "").split(".").sort(), f) {
                        for (u = p.event.special[f] || {}, h = d[f = (n ? u.delegateType : u.bindType) || f] || [], o = o[2] && new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = a = h.length; a--;) r = h[a], !s && g !== r.origType || i && i.guid !== r.guid || o && !o.test(r.namespace) || n && n !== r.selector && ("**" !== n || !r.selector) || (h.splice(a, 1), r.selector && h.delegateCount--, u.remove && u.remove.call(e, r));
                        l && !h.length && (u.teardown && !1 !== u.teardown.call(e, m, v.handle) || p.removeEvent(e, f, v.handle), delete d[f])
                    } else
                        for (f in d) p.event.remove(e, f + t[c], i, n, !0);
                p.isEmptyObject(d) && (delete v.handle, p._removeData(e, "events"))
            }
        },
        trigger: function(t, i, n, s) {
            var a, r, o, l, d, u, h, f = [n || S],
                m = c.call(t, "type") ? t.type : t,
                g = c.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = u = n = n || S, 3 !== n.nodeType && 8 !== n.nodeType && !Q.test(m + p.event.triggered) && (m.indexOf(".") >= 0 && (g = m.split("."), m = g.shift(), g.sort()), r = m.indexOf(":") < 0 && "on" + m, (t = t[p.expando] ? t : new p.Event(m, "object" == typeof t && t)).isTrigger = s ? 2 : 3, t.namespace = g.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), i = null == i ? [t] : p.makeArray(i, [t]), d = p.event.special[m] || {}, s || !d.trigger || !1 !== d.trigger.apply(n, i))) {
                if (!s && !d.noBubble && !p.isWindow(n)) {
                    for (l = d.delegateType || m, Q.test(l + m) || (o = o.parentNode); o; o = o.parentNode) f.push(o), u = o;
                    u === (n.ownerDocument || S) && f.push(u.defaultView || u.parentWindow || e)
                }
                for (h = 0;
                    (o = f[h++]) && !t.isPropagationStopped();) t.type = h > 1 ? l : d.bindType || m, (a = (p._data(o, "events") || {})[t.type] && p._data(o, "handle")) && a.apply(o, i), (a = r && o[r]) && a.apply && p.acceptData(o) && (t.result = a.apply(o, i), !1 === t.result && t.preventDefault());
                if (t.type = m, !s && !t.isDefaultPrevented() && (!d._default || !1 === d._default.apply(f.pop(), i)) && p.acceptData(n) && r && n[m] && !p.isWindow(n)) {
                    (u = n[r]) && (n[r] = null), p.event.triggered = m;
                    try {
                        n[m]()
                    } catch (e) {}
                    p.event.triggered = void 0, u && (n[r] = u)
                }
                return t.result
            }
        },
            ...
            if (l[0] = e, e.delegateTarget = this, !d.preDispatch || !1 !== d.preDispatch.call(this, e)) {
                for (o = p.event.handlers.call(this, e, c), t = 0;
                    ...
                    for (e.currentTarget = a.elem, r = 0;
                        (s = a.handlers[r++]) && !e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(s.namespace)) && (e.handleObj = s, e.data = s.data, void 0 !== (i = ((p.event.special[s.origType] || {}).handle || s.handler).apply(a.elem, l)) && !1 === (e.result = i) && (e.preventDefault(), e.stopPropagation()));
            ...
            if (o && l.nodeType && (!e.button || "click" !== e.type))
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
                        for (s = [], a = 0; o > a; a++) void 0 === s[i = (n = t[a]).selector + " "] && (s[i] = n.needsContext ? p(i, this).index(l) >= 0 : p.find(i, this, null, [l]).length), s[i] && s.push(n);
                        s.length && r.push({
                            elem: l,
                            handlers: s
                        })
        ...
        fix: function(e) {
            ...
            var t, i, n, s = e.type,
                a = e,
                r = this.fixHooks[s];
            for (r || (this.fixHooks[s] = r = K.test(s) ? this.mouseHooks : U.test(s) ? this.keyHooks : {}), n = r.props ? this.props.concat(r.props) : this.props, e = new p.Event(a), t = n.length; t--;) e[i = n[t]] = a[i];
            return e.target || (e.target = a.srcElement || S), 3 === e.target.nodeType && (e.target = e.target.parentNode), e.metaKey = !!e.metaKey, r.filter ? r.filter(e, a) : e
        },
    ...
    }, p.removeEvent = S.removeEventListener ? function(e, t, i) {
        ...
        p.event.special[e] = {
            ...
            handle: function(e) {
                var i, n = this,
                    s = e.relatedTarget,
                    a = e.handleObj;
                return (!s || s !== n && !p.contains(n, s)) && (e.type = a.origType, i = a.handler.apply(this, arguments), e.type = t), i
            }
        }
        ...
        setup: function() {
            return G.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (p.event.add(this, "propertychange._change", (function(e) {
                ...
                var t = e.target;
                G.test(t.nodeName) && !p._data(t, "changeBubbles") && (p.event.add(t, "change._change", (function(e) {
        ...
        on: function(e, t, i, n, s) {
            var a, r;
            if ("object" == typeof e) {
                for (a in "string" != typeof t && (i = i || t, t = void 0), e) this.on(a, t, i, e[a], s);
                return this
            }
    ...
    var ne = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        ve = ie(S).appendChild(S.createElement("div"));

    function ye(e, t) {
        var i, n, s = 0,
            a = typeof e.getElementsByTagName !== O ? e.getElementsByTagName(t || "*") : typeof e.querySelectorAll !== O ? e.querySelectorAll(t || "*") : void 0;
        if (!a)
            for (a = [], i = e.childNodes || e; null != (n = i[s]); s++) !t || p.nodeName(n, t) ? a.push(n) : p.merge(a, ye(n, t));
    ...
    function Ce(e, t) {
        if (1 === t.nodeType && p.hasData(e)) {
            var i, n, s, a = p._data(e),
                r = p._data(t, a),
                o = a.events;
            if (o)
                for (i in delete r.handle, r.events = {}, o)
                    for (n = 0, s = o[i].length; s > n; n++) p.event.add(t, i, o[i][n]);
    ...
    function Se(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            "script" === i && t.text !== e.text ? (xe(t).text = e.text, Te(t)) : "object" === i ? (t.parentNode && (t.outerHTML = e.outerHTML), u.html5Clone && e.innerHTML && !p.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === i && V.test(e.type) ? (t.defaultChecked = t.checked = e.checked, t.value !== e.value && (t.value = e.value)) : "option" === i ? t.defaultSelected = t.selected = e.defaultSelected : ("input" === i || "textarea" === i) && (t.defaultValue = e.defaultValue)
        }
    }
    ge.optgroup = ge.option, ge.tbody = ge.tfoot = ge.colgroup = ge.caption = ge.thead, ge.th = ge.td, p.extend({
        clone: function(e, t, i) {
            var n, s, a, r, o, l = p.contains(e.ownerDocument, e);
            if (u.html5Clone || p.isXMLDoc(e) || !ae.test("<" + e.nodeName + ">") ? a = e.cloneNode(!0) : (ve.innerHTML = e.outerHTML, ve.removeChild(a = ve.firstChild)), !(u.noCloneEvent && u.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || p.isXMLDoc(e)))
                for (n = ye(a), o = ye(e), r = 0; null != (s = o[r]); ++r) n[r] && Se(s, n[r]);
            if (t)
                if (i)
                    for (o = o || ye(e), n = n || ye(a), r = 0; null != (s = o[r]); r++) Ce(s, n[r]);
                else Ce(e, a);
            return (n = ye(a, "script")).length > 0 && Ee(n, !l && ye(e, "script")), n = o = s = null, a
        },
        buildFragment: function(e, t, i, n) {
            for (var s, a, r, o, l, c, d, h = e.length, f = ie(t), m = [], g = 0; h > g; g++)
                if ((a = e[g]) || 0 === a)
                    if ("object" === p.type(a)) p.merge(m, a.nodeType ? [a] : a);
                    else if (de.test(a)) {
                for (o = o || f.appendChild(t.createElement("div")), l = (le.exec(a) || ["", ""])[1].toLowerCase(), d = ge[l] || ge._default, o.innerHTML = d[1] + a.replace(oe, "<$1></$2>") + d[2], s = d[0]; s--;) o = o.lastChild;
                if (!u.leadingWhitespace && re.test(a) && m.push(t.createTextNode(re.exec(a)[0])), !u.tbody)
                    for (s = (a = "table" !== l || ce.test(a) ? "<table>" !== d[1] || ce.test(a) ? 0 : o : o.firstChild) && a.childNodes.length; s--;) p.nodeName(c = a.childNodes[s], "tbody") && !c.childNodes.length && a.removeChild(c);
                for (p.merge(m, o.childNodes), o.textContent = ""; o.firstChild;) o.removeChild(o.firstChild);
                o = f.lastChild
            } else m.push(t.createTextNode(a));
            for (o && f.removeChild(o), u.appendChecked || p.grep(ye(m, "input"), be), g = 0; a = m[g++];)
                if ((!n || -1 === p.inArray(a, n)) && (r = p.contains(a.ownerDocument, a), o = ye(f.appendChild(a), "script"), r && Ee(o), i))
                    for (s = 0; a = o[s++];) pe.test(a.type || "") && i.push(a);
            return o = null, f
        },
        cleanData: function(e, t) {
            for (var n, s, a, r, o = 0, l = p.expando, c = p.cache, d = u.deleteExpando, h = p.event.special; null != (n = e[o]); o++)
                if ((t || p.acceptData(n)) && (r = (a = n[l]) && c[a])) {
                    if (r.events)
                        for (s in r.events) h[s] ? p.event.remove(n, s) : p.removeEvent(n, s, r.handle);
                    c[a] && (delete c[a], d ? delete n[l] : typeof n.removeAttribute !== O ? n.removeAttribute(l) : n[l] = null, i.push(a))
                }
        }
    }), p.fn.extend({
        text: function(e) {
        ...
        remove: function(e, t) {
            for (var i, n = e ? p.filter(e, this) : this, s = 0; null != (i = n[s]); s++) t || 1 !== i.nodeType || p.cleanData(ye(i)), i.parentNode && (t && p.contains(i.ownerDocument, i) && Ee(ye(i, "script")), i.parentNode.removeChild(i));
            return this
        },
        empty: function() {
        ...
        html: function(e) {
            return Y(this, (function(e) {
                ...
                if (!("string" != typeof e || ue.test(e) || !u.htmlSerialize && ae.test(e) || !u.leadingWhitespace && re.test(e) || ge[(le.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(oe, "<$1></$2>");
                    try {
                        for (; n > i; i++) 1 === (t = this[i] || {}).nodeType && (p.cleanData(ye(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        domManip: function(e, t) {
            ...
            var i, n, a, r, o, l, c = 0,
                ...
                m = e[0],
                g = p.isFunction(m);
            if (g || d > 1 && "string" == typeof m && !u.checkClone && he.test(m)) return this.each((function(i) {
                var n = h.eq(i);
                g && (e[0] = m.call(this, i, n.html())), n.domManip(e, t)
            }));
            if (d && (i = (l = p.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild, 1 === l.childNodes.length && (l = i), i)) {
                for (a = (r = p.map(ye(l, "script"), xe)).length; d > c; c++) n = l, c !== f && (n = p.clone(n, !0, !0), a && p.merge(r, ye(n, "script"))), t.call(this[c], n, c);
                if (a)
                    for (o = r[r.length - 1].ownerDocument, p.map(r, Te), c = 0; a > c; c++) n = r[c], pe.test(n.type || "") && !p._data(n, "globalEval") && p.contains(o, n) && (n.src ? p._evalUrl && p._evalUrl(n.src) : p.globalEval((n.text || n.textContent || n.innerHTML || "").replace(me, "")));
                l = i = null
            }
            return this
        }
        ...
        p.fn[e] = function(e) {
            for (var i, n = 0, s = [], r = p(e), o = r.length - 1; o >= n; n++) i = n === o ? this : this.clone(!0), p(r[n])[t](i), a.apply(s, i.get());
    ...
    function Pe(t, i) {
        var n = p(i.createElement(t)).appendTo(i.body),
            s = e.getDefaultComputedStyle ? e.getDefaultComputedStyle(n[0]).display : p.css(n[0], "display");
        return n.detach(), s
    }
    ...
    function Me(e) {
        var t = S,
            i = ke[e];
        return i || ("none" !== (i = Pe(e, t)) && i || ((t = ((_e = (_e || p("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || _e[0].contentDocument).document).write(), t.close(), i = Pe(e, t), _e.detach()), ke[e] = i), i
    }! function() {
        var e, t, i = S.createElement("div");
        i.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", (e = i.getElementsByTagName("a")[0]).style.cssText = "float:left;opacity:.5", u.opacity = /^0.5/.test(e.style.opacity), u.cssFloat = !!e.style.cssFloat, i.style.backgroundClip = "content-box", i.cloneNode(!0).style.backgroundClip = "", u.clearCloneStyle = "content-box" === i.style.backgroundClip, e = i = null, u.shrinkWrapBlocks = function() {
            var e, i, n;
            if (null == t) {
                if (!(e = S.getElementsByTagName("body")[0])) return;
                "border:0;width:0;height:0;position:absolute;top:0;left:-9999px", i = S.createElement("div"), n = S.createElement("div"), e.appendChild(i).appendChild(n), t = !1, typeof n.style.zoom !== O && (n.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0;width:1px;padding:1px;zoom:1", n.innerHTML = "<div></div>", n.firstChild.style.width = "5px", t = 3 !== n.offsetWidth), e.removeChild(i), e = i = n = null
            }
            return t
        }
    }();
    ...
    e.getComputedStyle ? (De = function(e) {
            ...
            return r = (i = i || De(e)) ? i.getPropertyValue(t) || i[t] : void 0, i && ("" !== r || p.contains(e.ownerDocument, e) || (r = p.style(e, t)), Le.test(r) && Ie.test(t) && (n = o.width, s = o.minWidth, a = o.maxWidth, o.minWidth = o.maxWidth = o.width = r, r = i.width, o.width = n, o.minWidth = s, o.maxWidth = a)), void 0 === r ? r : r + ""
        }) : S.documentElement.currentStyle && (De = function(e) {
            return e.currentStyle
        }, Ae = function(e, t, i) {
            var n, s, a, r, o = e.style;
            return null == (r = (i = i || De(e)) ? i[t] : void 0) && o && o[t] && (r = o[t]), Le.test(r) && !$e.test(t) && (n = o.left, (a = (s = e.runtimeStyle) && s.left) && (s.left = e.currentStyle.left), o.left = "fontSize" === t ? "1em" : r, r = o.pixelLeft + "px", o.left = n, a && (s.left = a)), void 0 === r ? r : r + "" || "auto"
        }),
        function() {
            var t, i, n, s, a, r, o = S.createElement("div"),
                l = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px";

            function c() {
                var t, i, o = S.getElementsByTagName("body")[0];
                o && (t = S.createElement("div"), i = S.createElement("div"), t.style.cssText = l, o.appendChild(t).appendChild(i), i.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;display:block;padding:1px;border:1px;width:4px;margin-top:1%;top:1%", p.swap(o, null != o.style.zoom ? {
                    zoom: 1
                } : {}, (function() {
                    n = 4 === i.offsetWidth
                })), s = !0, a = !1, r = !0, e.getComputedStyle && (a = "1%" !== (e.getComputedStyle(i, null) || {}).top, s = "4px" === (e.getComputedStyle(i, null) || {
                    width: "4px"
                }).width), o.removeChild(t), i = o = null)
            }
            o.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", (t = o.getElementsByTagName("a")[0]).style.cssText = "float:left;opacity:.5", u.opacity = /^0.5/.test(t.style.opacity), u.cssFloat = !!t.style.cssFloat, o.style.backgroundClip = "content-box", o.cloneNode(!0).style.backgroundClip = "", u.clearCloneStyle = "content-box" === o.style.backgroundClip, t = o = null, p.extend(u, {
                reliableHiddenOffsets: function() {
                    if (null != i) return i;
                    var e, t, n, s = S.createElement("div"),
                        a = S.getElementsByTagName("body")[0];
                    return a ? (s.setAttribute("className", "t"), s.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", (e = S.createElement("div")).style.cssText = l, a.appendChild(e).appendChild(s), s.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", (t = s.getElementsByTagName("td"))[0].style.cssText = "padding:0;margin:0;border:0;display:none", n = 0 === t[0].offsetHeight, t[0].style.display = "", t[1].style.display = "none", i = n && 0 === t[0].offsetHeight, a.removeChild(e), s = a = null, i) : void 0
                },
                boxSizing: function() {
                    return null == n && c(), n
                },
                ...
                reliableMarginRight: function() {
                    ...
                    if (null == r && e.getComputedStyle) {
                        if (!(t = S.getElementsByTagName("body")[0])) return;
                        i = S.createElement("div"), n = S.createElement("div"), i.style.cssText = l, t.appendChild(i).appendChild(n), (s = n.appendChild(S.createElement("div"))).style.cssText = n.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0", s.style.marginRight = s.style.width = "0", n.style.width = "1px", r = !parseFloat((e.getComputedStyle(s, null) || {}).marginRight), t.removeChild(i)
                    }
                    return r
                }
            })
    ...
    function Xe(e, t) {
        for (var i, n, s, a = [], r = 0, o = e.length; o > r; r++)(n = e[r]).style && (a[r] = p._data(n, "olddisplay"), i = n.style.display, t ? (a[r] || "none" !== i || (n.style.display = ""), "" === n.style.display && X(n) && (a[r] = p._data(n, "olddisplay", Me(n.nodeName)))) : a[r] || (s = X(n), (i && "none" !== i || !s) && p._data(n, "olddisplay", s ? i : p.css(n, "display"))));
        for (r = 0; o > r; r++)(n = e[r]).style && (t && "none" !== n.style.display && "" !== n.style.display || (n.style.display = t ? a[r] || "" : "none"));
        return e
    }
    ...
    function Ve(e, t, i, n, s) {
        for (var a = i === (n ? "border" : "content") ? 4 : "width" === t ? 1 : 0, r = 0; 4 > a; a += 2) "margin" === i && (r += p.css(e, i + W[a], !0, s)), n ? ("content" === i && (r -= p.css(e, "padding" + W[a], !0, s)), "margin" !== i && (r -= p.css(e, "border" + W[a] + "Width", !0, s))) : (r += p.css(e, "padding" + W[a], !0, s), "padding" !== i && (r += p.css(e, "border" + W[a] + "Width", !0, s)));
        return r
    }
    ...
    function Ge(e, t, i) {
        var n = !0,
            ...
            a = De(e),
            r = u.boxSizing() && "border-box" === p.css(e, "boxSizing", !1, a);
        if (0 >= s || null == s) {
            if ((0 > (s = Ae(e, t, a)) || null == s) && (s = e.style[t]), Le.test(s)) return s;
            n = r && (u.boxSizingReliable() || s === e.style[t]), s = parseFloat(s) || 0
        }
        return s + Ve(e, t, i || (r ? "border" : "content"), n, a) + "px"
    }
    ...
    p.extend({
        ...
        style: function(e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var s, a, r, o = p.camelCase(t),
                    l = e.style;
                if (t = p.cssProps[o] || (p.cssProps[o] = We(l, o)), r = p.cssHooks[t] || p.cssHooks[o], void 0 === i) return r && "get" in r && void 0 !== (s = r.get(e, !1, n)) ? s : l[t];
                if ("string" === (a = typeof i) && (s = Fe.exec(i)) && (i = (s[1] + 1) * s[2] + parseFloat(p.css(e, t)), a = "number"), null != i && i == i && ("number" !== a || p.cssNumber[o] || (i += "px"), u.clearCloneStyle || "" !== i || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(r && "set" in r && void 0 === (i = r.set(e, i, n))))) try {
                    l[t] = "", l[t] = i
                } catch (e) {}
            }
        },
        css: function(e, t, i, n) {
            var s, a, r, o = p.camelCase(t);
            return t = p.cssProps[o] || (p.cssProps[o] = We(e.style, o)), (r = p.cssHooks[t] || p.cssHooks[o]) && "get" in r && (a = r.get(e, !0, i)), void 0 === a && (a = Ae(e, t, n)), "normal" === a && t in Re && (a = Re[t]), "" === i || i ? (s = parseFloat(a), !0 === i || p.isNumeric(s) ? s || 0 : a) : a
        }
    }), p.each(["height", "width"], (function(e, t) {
        p.cssHooks[t] = {
            get: function(e, i, n) {
                return i ? 0 === e.offsetWidth && He.test(p.css(e, "display")) ? p.swap(e, Be, (function() {
                    return Ge(e, t, n)
                })) : Ge(e, t, n) : void 0
            },
            set: function(e, i, n) {
                var s = n && De(e);
                return Ye(0, i, n ? Ve(e, t, n, u.boxSizing() && "border-box" === p.css(e, "boxSizing", !1, s), s) : 0)
            }
        }
        ...
        set: function(e, t) {
            ...
            i.zoom = 1, (t >= 1 || "" === t) && "" === p.trim(a.replace(Oe, "")) && i.removeAttribute && (i.removeAttribute("filter"), "" === t || n && !n.filter) || (i.filter = Oe.test(a) ? a.replace(Oe, s) : a + " " + s)
        }
    }), p.cssHooks.marginRight = Ne(u.reliableMarginRight, (function(e, t) {
        return t ? p.swap(e, {
        ...
        p.cssHooks[e + t] = {
            expand: function(i) {
                for (var n = 0, s = {}, a = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) s[e + W[n] + t] = a[n] || a[n - 2] || a[0];
                return s
            }
        ...
        css: function(e, t) {
            return Y(this, (function(e, t, i) {
                var n, s, a = {},
                    r = 0;
                if (p.isArray(t)) {
                    for (n = De(e), s = t.length; s > r; r++) a[t[r]] = p.css(e, t[r], !1, n);
                    return a
                }
    ...
    }), p.Tween = Ue, Ue.prototype = {
        constructor: Ue,
        init: function(e, t, i, n, s, a) {
            this.elem = e, this.prop = i, this.easing = s || "swing", this.options = t, this.start = this.now = this.cur(), this.end = n, this.unit = a || (p.cssNumber[i] ? "" : "px")
        },
        cur: function() {
        ...
        run: function(e) {
            ...
            return this.pos = t = this.options.duration ? p.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : Ue.propHooks._default.set(this), this
        }
    ...
    }, p.fx = Ue.prototype.init, p.fx.step = {};
    var Ke, Qe, Ze = /^(?:toggle|show|hide)$/,
        Je = new RegExp("^(?:([+-])=|)(" + q + ")([a-z%]*)$", "i"),
        et = /queueHooks$/,
        tt = [function(e, t, i) {
            var n, s, a, r, o, l, c, d, h = this,
                f = {},
                m = e.style,
                g = e.nodeType && X(e),
                v = p._data(e, "fxshow");
            for (n in i.queue || (null == (o = p._queueHooks(e, "fx")).unqueued && (o.unqueued = 0, l = o.empty.fire, o.empty.fire = function() {
                ...
                }))), 1 === e.nodeType && ("height" in t || "width" in t) && (i.overflow = [m.overflow, m.overflowX, m.overflowY], c = p.css(e, "display"), d = Me(e.nodeName), "none" === c && (c = d), "inline" === c && "none" === p.css(e, "float") && (u.inlineBlockNeedsLayout && "inline" !== d ? m.zoom = 1 : m.display = "inline-block")), i.overflow && (m.overflow = "hidden", u.shrinkWrapBlocks() || h.always((function() {
                    m.overflow = i.overflow[0], m.overflowX = i.overflow[1], m.overflowY = i.overflow[2]
                }))), t)
                if (s = t[n], Ze.exec(s)) {
                    if (delete t[n], a = a || "toggle" === s, s === (g ? "hide" : "show")) {
            ...
            if (!p.isEmptyObject(f))
                for (n in v ? "hidden" in v && (g = v.hidden) : v = p._data(e, "fxshow", {}), a && (v.hidden = !g), g ? p(e).show() : h.done((function() {
                        p(e).hide()
                    })), h.done((function() {
                        var t;
                        for (t in p._removeData(e, "fxshow"), f) p.style(e, t, f[t])
                    })), f) r = at(g ? v[n] : 0, n, h), n in v || (v[n] = r.start, g && (r.end = r.start, r.start = "width" === n || "height" === n ? 1 : 0))
        }],
        it = {
            "*": [function(e, t) {
                var i = this.createTween(e, t),
                    n = i.cur(),
                    s = Je.exec(t),
                    a = s && s[3] || (p.cssNumber[e] ? "" : "px"),
                    r = (p.cssNumber[e] || "px" !== a && +n) && Je.exec(p.css(i.elem, e)),
                    o = 1,
                    l = 20;
                if (r && r[3] !== a) {
                    a = a || r[3], s = s || [], r = +n || 1;
                    do {
                        r /= o = o || ".5", p.style(i.elem, e, r + a)
    ...
    function at(e, t, i) {
        for (var n, s = (it[t] || []).concat(it["*"]), a = 0, r = s.length; r > a; a++)
    ...
    function rt(e, t, i) {
        var n, s, a = 0,
            ...
            l = function() {
                if (s) return !1;
                for (var t = Ke || nt(), i = Math.max(0, c.startTime + c.duration - t), n = 1 - (i / c.duration || 0), a = 0, r = c.tweens.length; r > a; a++) c.tweens[a].run(n);
                return o.notifyWith(e, [c, n, i]), 1 > n && r ? i : (o.resolveWith(e, [c]), !1)
            },
            c = o.promise({
                elem: e,
                props: p.extend({}, t),
        ...
        for (function(e, t) {
                var i, n, s, a, r;
                for (i in e)
                    if (s = t[n = p.camelCase(i)], a = e[i], p.isArray(a) && (s = a[1], a = e[i] = a[0]), i !== n && (e[n] = a, delete e[i]), (r = p.cssHooks[n]) && "expand" in r)
                        for (i in a = r.expand(a), delete e[n], a) i in e || (e[i] = a[i], t[i] = s);
                    else t[n] = s
            }(d, c.opts.specialEasing); r > a; a++)
            if (n = tt[a].call(c, e, d, c.opts)) return n;
        return p.map(d, at, c), p.isFunction(c.opts.start) && c.opts.start.call(e, c), p.fx.timer(p.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
    ...
    p.Animation = p.extend(rt, {
            ...
            finish: function(e) {
                return !1 !== e && (e = e || "fx"), this.each((function() {
                    var t, i = p._data(this),
                        ...
                        a = p.timers,
                        r = n ? n.length : 0;
                    for (i.finish = !0, p.queue(this, e, []), s && s.stop && s.stop.call(this, !0), t = a.length; t--;) a[t].elem === this && a[t].queue === e && (a[t].anim.stop(!0), a.splice(t, 1));
            ...
            var e, t = p.timers,
                i = 0;
            for (Ke = p.now(); i < t.length; i++)(e = t[i])() || t[i] !== e || t.splice(i--, 1);
        ...
        function() {
            var e, t, i, n, s = S.createElement("div");
            s.setAttribute("className", "t"), s.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", e = s.getElementsByTagName("a")[0], n = (i = S.createElement("select")).appendChild(S.createElement("option")), t = s.getElementsByTagName("input")[0], e.style.cssText = "top:1px", u.getSetAttribute = "t" !== s.className, u.style = /top/.test(e.getAttribute("style")), u.hrefNormalized = "/a" === e.getAttribute("href"), u.checkOn = !!t.value, u.optSelected = n.selected, u.enctype = !!S.createElement("form").enctype, i.disabled = !0, u.optDisabled = !n.disabled, (t = S.createElement("input")).setAttribute("value", ""), u.input = "" === t.getAttribute("value"), t.value = "t", t.setAttribute("type", "radio"), u.radioValue = "t" === t.value, e = t = i = n = s = null
        }();
    var ot = /\r/g;
    p.fn.extend({
        val: function(e) {
            ...
            }))) : s ? (t = p.valHooks[s.type] || p.valHooks[s.nodeName.toLowerCase()]) && "get" in t && void 0 !== (i = t.get(s, "value")) ? i : "string" == typeof(i = s.value) ? i.replace(ot, "") : null == i ? "" : i : void 0
        }
    }), p.extend({
        valHooks: {
            option: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var i, n, s = e.options, a = p.makeArray(t), r = s.length; r--;)
                        if (n = s[r], p.inArray(p.valHooks.option.get(n), a) >= 0) try {
                            n.selected = i = !0
                        } catch (e) {
                            n.scrollHeight
                        } else n.selected = !1;
    ...
    var lt, ct, dt = p.expr.attrHandle,
        ut = /^(?:checked|selected)$/i,
        ht = u.getSetAttribute,
        pt = u.input;
    p.fn.extend({
        attr: function(e, t) {
        ...
        attr: function(e, t, i) {
            var n, s, a = e.nodeType;
            if (e && 3 !== a && 8 !== a && 2 !== a) return typeof e.getAttribute === O ? p.prop(e, t, i) : (1 === a && p.isXMLDoc(e) || (t = t.toLowerCase(), n = p.attrHooks[t] || (p.expr.match.bool.test(t) ? ct : lt)), void 0 === i ? n && "get" in n && null !== (s = n.get(e, t)) ? s : null == (s = p.find.attr(e, t)) ? void 0 : s : null !== i ? n && "set" in n && void 0 !== (s = n.set(e, i, t)) ? s : (e.setAttribute(t, i + ""), i) : void p.removeAttr(e, t))
        },
        removeAttr: function(e, t) {
            var i, n, s = 0,
                a = t && t.match(A);
            if (a && 1 === e.nodeType)
                for (; i = a[s++];) n = p.propFix[i] || i, p.expr.match.bool.test(i) ? pt && ht || !ut.test(i) ? e[n] = !1 : e[p.camelCase("default-" + i)] = e[n] = !1 : p.attr(e, i, ""), e.removeAttribute(ht ? i : n)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        set: function(e, t, i) {
            return !1 === t ? p.removeAttr(e, i) : pt && ht || !ut.test(i) ? e.setAttribute(!ht && p.propFix[i] || i, i) : e[p.camelCase("default-" + i)] = e[i] = !0, i
        }
    }, p.each(p.expr.match.bool.source.match(/\w+/g), (function(e, t) {
        var i = dt[t] || p.find.attr;
        dt[t] = pt && ht || !ut.test(t) ? function(e, t, n) {
            var s, a;
            return n || (a = dt[t], dt[t] = s, s = null != i(e, t, n) ? t.toLowerCase() : null, dt[t] = a), s
        } : function(e, t, i) {
            return i ? void 0 : e[p.camelCase("default-" + t)] ? t.toLowerCase() : null
        }
    })), pt && ht || (p.attrHooks.value = {
        set: function(e, t, i) {
            return p.nodeName(e, "input") ? void(e.defaultValue = t) : lt && lt.set(e, t, i)
        }
    }), ht || (lt = {
        set: function(e, t, i) {
    ...
    p.fn.extend({
        ...
        prop: function(e, t, i) {
            var n, s, a = e.nodeType;
            if (e && 3 !== a && 8 !== a && 2 !== a) return (1 !== a || !p.isXMLDoc(e)) && (t = p.propFix[t] || t, s = p.propHooks[t]), void 0 !== i ? s && "set" in s && void 0 !== (n = s.set(e, i, t)) ? n : e[t] = i : s && "get" in s && null !== (n = s.get(e, t)) ? n : e[t]
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
    ...
    p.fn.extend({
        addClass: function(e) {
            ...
            if (c)
                for (t = (e || "").match(A) || []; l > o; o++)
                    if (n = 1 === (i = this[o]).nodeType && (i.className ? (" " + i.className + " ").replace(gt, " ") : " ")) {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === i ? t ? this.addClass(e) : this.removeClass(e) : this.each(p.isFunction(e) ? function(i) {
                ...
                if ("string" === i)
                    for (var t, n = 0, s = p(this), a = e.match(A) || []; t = a[n++];) s.hasClass(t) ? s.removeClass(t) : s.addClass(t);
                else(i === O || "boolean" === i) && (this.className && p._data(this, "__className__", this.className), this.className = this.className || !1 === e ? "" : p._data(this, "__className__") || "")
            })
        },
        hasClass: function(e) {
            for (var t = " " + e + " ", i = 0, n = this.length; n > i; i++)
                if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(gt, " ").indexOf(t) >= 0) return !0;
            return !1
        }
    ...
    p.parseJSON = function(t) {
        ...
        var i, n = null,
            s = p.trim(t + "");
        return s && !p.trim(s.replace(bt, (function(e, t, s, a) {
    ...
    try {
        ...
        (xt = S.createElement("a")).href = "", xt = xt.href
    }
    ...
    wt = kt.exec(xt.toLowerCase()) || [], p.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajaxSetup: function(e, t) {
            return t ? Lt(Lt(e, p.ajaxSettings), t) : Lt(p.ajaxSettings, e)
        },
        ajaxPrefilter: At(Pt),
        ajaxTransport: At(Mt),
        ajax: function(e, t) {
            "object" == typeof e && (t = e, e = void 0), t = t || {};
            var i, n, s, a, r, o, l, c, d = p.ajaxSetup({}, t),
                u = d.context || d,
            ...
            if (f.promise(x).complete = m.add, x.success = x.done, x.error = x.fail, d.url = ((e || d.url || xt) + "").replace(Tt, "").replace(_t, wt[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = p.trim(d.dataType || "*").toLowerCase().match(A) || [""], null == d.crossDomain && (i = kt.exec(d.url.toLowerCase()), d.crossDomain = !(!i || i[1] === wt[1] && i[2] === wt[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (wt[3] || ("http:" === wt[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = p.param(d.data, d.traditional)), It(Pt, d, t, x), 2 === b) return x;
            ...
            if (l = It(Mt, d, t, x)) {
                x.readyState = 1, o && h.trigger("ajaxSend", [x, d]), d.async && d.timeout > 0 && (r = setTimeout((function() {
                    x.abort("timeout")
                }), d.timeout));
                try {
                    b = 1, l.send(v, T)
            ...
            function T(e, t, i, n) {
                var c, v, y, w, T, E = t;
                2 !== b && (b = 2, r && clearTimeout(r), l = void 0, a = n || "", x.readyState = e > 0 ? 4 : 0, c = e >= 200 && 300 > e || 304 === e, i && (w = function(e, t, i) {
    ...
    function jt(e, t, i, n) {
        ...
        if (p.isArray(t)) p.each(t, (function(t, s) {
            i || Nt.test(e) ? n(e, s) : jt(e + "[" + ("object" == typeof s ? t : "") + "]", s, i, n)
        }));
        else if (i || "object" !== p.type(t)) n(e, t);
        else
            for (s in t) jt(e + "[" + s + "]", t[s], i, n)
    }
    p.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map((function() {
                ...
                var e = this.type;
                return this.name && !p(this).is(":disabled") && Ht.test(this.nodeName) && !zt.test(e) && (this.checked || !V.test(e))
            })).map((function(e, t) {
                var i = p(this).val();
    ...
    e.ActiveXObject && p(e).on("unload", (function() {
    ...
    })), u.cors = !!Rt && "withCredentials" in Rt, (Rt = u.ajax = !!Rt) && p.ajaxTransport((function(e) {
        var t;
        if (!e.crossDomain || u.cors) return {
            send: function(i, n) {
                ...
                for (s in e.mimeType && a.overrideMimeType && a.overrideMimeType(e.mimeType), e.crossDomain || i["X-Requested-With"] || (i["X-Requested-With"] = "XMLHttpRequest"), i) void 0 !== i[s] && a.setRequestHeader(s, i[s] + "");
                a.send(e.hasContent && e.data || null), t = function(i, s) {
                    var o, l, c;
                    if (t && (s || 4 === a.readyState))
                        if (delete Bt[r], t = void 0, a.onreadystatechange = p.noop, s) 4 !== a.readyState && a.abort();
                        else {
                    ...
                    c && n(o, l, c, a.getAllResponseHeaders())
                }, e.async ? 4 === a.readyState ? setTimeout(t) : a.onreadystatechange = Bt[r] = t : t()
            },
            abort: function() {
                t && t(void 0, !0)
            }
        ...
        if (e.crossDomain) {
            var t, i = S.head || p("head")[0] || S.documentElement;
            return {
                send: function(n, s) {
                    (t = S.createElement("script")).async = !0, e.scriptCharset && (t.charset = e.scriptCharset), t.src = e.url, t.onload = t.onreadystatechange = function(e, i) {
    ...
    p.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = Wt.pop() || p.expando + "_" + vt++;
            return this[e] = !0, e
        }
    }), p.ajaxPrefilter("json jsonp", (function(t, i, n) {
        var s, a, r, o = !1 !== t.jsonp && (Xt.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Xt.test(t.data) && "data");
        return o || "jsonp" === t.dataTypes[0] ? (s = t.jsonpCallback = p.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, o ? t[o] = t[o].replace(Xt, "$1" + s) : !1 !== t.jsonp && (t.url += (yt.test(t.url) ? "&" : "?") + t.jsonp + "=" + s), t.converters["script json"] = function() {
            return r || p.error(s + " was not called"), r[0]
        }, t.dataTypes[0] = "json", a = e[s], e[s] = function() {
            r = arguments
        }, n.always((function() {
            e[s] = a, t[s] && (t.jsonpCallback = i.jsonpCallback, Wt.push(s)), r && p.isFunction(a) && a(r[0]), r = a = void 0
        })), "script") : void 0
    ...
    p.fn.load = function(e, t, i) {
        ...
        var n, s, a, r = this,
            o = e.indexOf(" ");
        return o >= 0 && (n = e.slice(o, e.length), e = e.slice(0, o)), p.isFunction(t) ? (i = t, t = void 0) : t && "object" == typeof t && (a = "POST"), r.length > 0 && p.ajax({
            url: e,
            type: a,
            dataType: "html",
            data: t
    ...
    p.offset = {
        setOffset: function(e, t, i) {
            var n, s, a, r, o, l, c = p.css(e, "position"),
                d = p(e),
                u = {};
        ...
        offset: function(e) {
            ...
            var t, i, n = {
                ...
                s = this[0],
                a = s && s.ownerDocument;
            return a ? (t = a.documentElement, p.contains(t, s) ? (typeof s.getBoundingClientRect !== O && (n = s.getBoundingClientRect()), i = Gt(a), {
        ...
        offsetParent: function() {
            return this.map((function() {
                for (var e = this.offsetParent || Vt; e && !p.nodeName(e, "html") && "static" === p.css(e, "position");) e = e.offsetParent;
                return e || Vt
            }))
        }
    }), p.each({
        ...
        p.fn[e] = function(n) {
            return Y(this, (function(e, n, s) {
                var a = Gt(e);
                return void 0 === s ? a ? t in a ? a[t] : a.document.documentElement[n] : e[n] : void(a ? a.scrollTo(i ? p(a).scrollLeft() : s, i ? s : p(a).scrollTop()) : e[n] = s)
            }), e, n, arguments.length, null)
        }
    })), p.each(["top", "left"], (function(e, t) {
        p.cssHooks[t] = Ne(u.pixelPosition, (function(e, i) {
            return i ? (i = Ae(e, t), Le.test(i) ? p(e).position()[t] + "px" : i) : void 0
        }))
    })), p.each({
        Height: "height",
        Width: "width"
        ...
        p.each({
            ...
            p.fn[n] = function(n, s) {
                ...
                return Y(this, (function(t, i, n) {
                    var s;
                    return p.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (s = t.documentElement, Math.max(t.body["scroll" + e], s["scroll" + e], t.body["offset" + e], s["offset" + e], s["client" + e])) : void 0 === n ? p.css(t, i, r) : p.style(t, i, n, r)
                }), t, a ? n : void 0, a, null)
            }
        }))
    })), p.fn.size = function() {
    ...
    return p.noConflict = function(t) {
        return e.$ === p && (e.$ = Kt), t && e.jQuery === p && (e.jQuery = Ut), p
    }, typeof t === O && (e.jQuery = e.$ = p), p
})),
function(e, t) {
        ...
        typeCheckConfig: function(e, t, i) {
            for (var n in i)
                if (Object.prototype.hasOwnProperty.call(i, n)) {
                    var s = i[n],
                        a = t[n],
                        r = a && o.isElement(a) ? "element" : (l = a, {}.toString.call(l).match(/\s([a-z]+)/i)[1].toLowerCase());
    ...
    t(document).on(T.CLICK_DATA_API, w, (function(e) {
        e.preventDefault();
        var i = e.target;
        t(i).hasClass("btn") || (i = t(i).closest(x)), E._jQueryInterface.call(t(i), "toggle")
        ...
        return t.fn[f] = y, E._jQueryInterface
    };
    var C = "carousel",
        S = "bs.carousel",
        _ = "." + S,
        ...
        H = function() {
            ...
            return i.next = function() {
                ...
                return e = a({}, M, e), o.typeCheckConfig(C, e, D), e
                ...
                var r = (s + (e === I ? -1 : 1)) % this._items.length;
                ...
                if (a = e === A ? (n = "carousel-item-left", s = "carousel-item-next", "left") : (n = "carousel-item-right", s = "carousel-item-prev", "right"), d && t(d).hasClass($)) this._isSliding = !1;
                else if (!this._triggerSlideEvent(d, a).isDefaultPrevented() && l && d) {
                    ...
                    if (t(this._element).hasClass("slide")) {
                        t(d).addClass(s), o.reflow(d), t(l).addClass(n), t(d).addClass(n);
                        ...
                        t(l).one(o.TRANSITION_END, (function() {
                            t(d).removeClass(n + " " + s).addClass($), t(l).removeClass($ + " " + s + " " + n), r._isSliding = !1, setTimeout((function() {
                                return t(r._element).trigger(p)
                            }), 0)
                        })).emulateTransitionEnd(m)
                    } else t(l).removeClass($), t(d).addClass($), this._isSliding = !1, t(this._element).trigger(p);
                    h && this.cycle()
                }
            }, e._jQueryInterface = function(i) {
                return this.each((function() {
    ...
    t(document).on(L.CLICK_DATA_API, "[data-slide], [data-slide-to]", H._dataApiClickHandler), t(window).on(L.LOAD_DATA_API, (function() {
        for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), i = 0, n = e.length; i < n; i++) {
            var s = t(e[i]);
            H._jQueryInterface.call(s, s.data())
        }
    })), t.fn[C] = H._jQueryInterface, t.fn[C].Constructor = H, t.fn[C].noConflict = function() {
    ...
    var j = "collapse",
        ...
        Q = function() {
            function e(e, t) {
                ...
                for (var i = [].slice.call(document.querySelectorAll(K)), n = 0, s = i.length; n < s; n++) {
                    var a = i[n],
                        r = o.getSelectorFromElement(a),
                        l = [].slice.call(document.querySelectorAll(r)).filter((function(t) {
                            return t === e
                        }));
                    null !== r && 0 < l.length && (this._selector = r, this._triggerArray.push(a))
                }
            ...
            return i.toggle = function() {
                ...
                if (!(this._isTransitioning || t(this._element).hasClass(Y) || (this._parent && 0 === (i = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter((function(e) {
                        return "string" == typeof s._config.parent ? e.getAttribute("data-parent") === s._config.parent : e.classList.contains(V)
                    }))).length && (i = null), i && (n = t(i).not(this._selector).data(F)) && n._isTransitioning))) {
                    var a = t.Event(X.SHOW);
                    if (t(this._element).trigger(a), !a.isDefaultPrevented()) {
                        i && (e._jQueryInterface.call(t(i).not(this._selector), "hide"), n || t(i).data(F, null));
                        var r = this._getDimension();
                        t(this._element).removeClass(V).addClass(G), this._element.style[r] = 0, this._triggerArray.length && t(this._triggerArray).removeClass(U).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var l = "scroll" + (r[0].toUpperCase() + r.slice(1)),
                            c = o.getTransitionDurationFromElement(this._element);
                        t(this._element).one(o.TRANSITION_END, (function() {
                            t(s._element).removeClass(G).addClass(V).addClass(Y), s._element.style[r] = "", s.setTransitioning(!1), t(s._element).trigger(X.SHOWN)
                ...
                if (!this._isTransitioning && t(this._element).hasClass(Y)) {
                    var i = t.Event(X.HIDE);
                    if (t(this._element).trigger(i), !i.isDefaultPrevented()) {
                        var n = this._getDimension();
                        this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", o.reflow(this._element), t(this._element).addClass(G).removeClass(V).removeClass(Y);
                        var s = this._triggerArray.length;
                        if (0 < s)
                            for (var a = 0; a < s; a++) {
                                var r = this._triggerArray[a],
                                    l = o.getSelectorFromElement(r);
                                null !== l && (t([].slice.call(document.querySelectorAll(l))).hasClass(Y) || t(r).addClass(U).attr("aria-expanded", !1))
                            }
                        this.setTransitioning(!0), this._element.style[n] = "";
                        var c = o.getTransitionDurationFromElement(this._element);
                        t(this._element).one(o.TRANSITION_END, (function() {
                            e.setTransitioning(!1), t(e._element).removeClass(G).addClass(V).trigger(X.HIDDEN)
                ...
                return (e = a({}, q, e)).toggle = Boolean(e.toggle), o.typeCheckConfig(j, e, W), e
                ...
                i.length && t(i).toggleClass(U, !n).attr("aria-expanded", n)
                ...
                return this.each((function() {
                    var n = t(this),
                        s = n.data(F),
                        r = a({}, q, n.data(), "object" == typeof i && i ? i : {});
                    if (!s && r.toggle && /show|hide/.test(i) && (r.toggle = !1), s || (s = new e(this, r), n.data(F, s)), "string" == typeof i) {
    ...
    t(document).on(X.CLICK_DATA_API, K, (function(e) {
        ...
        t(s).each((function() {
            var e = t(this),
                n = e.data(F) ? "toggle" : i.data();
            Q._jQueryInterface.call(e, n)
        }))
    })), t.fn[j] = Q._jQueryInterface, t.fn[j].Constructor = Q, t.fn[j].noConflict = function() {
        return t.fn[j] = R, Q._jQueryInterface
    };
    var Z = "dropdown",
        J = "bs.dropdown",
        ee = "." + J,
        ...
        he = function() {
            ...
            return n.toggle = function() {
                if (!this._element.disabled && !t(this._element).hasClass(ae)) {
                    ...
                    if (e._clearMenus(), !s) {
                        ...
                        if (t(n).trigger(r), !r.isDefaultPrevented()) {
                            ...
                            "ontouchstart" in document.documentElement && 0 === t(n).closest(".navbar-nav").length && t(document.body).children().on("mouseover", null, t.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), t(this._menu).toggleClass(re), t(n).toggleClass(re).trigger(t.Event(se.SHOWN, a))
                        }
                    }
                }
            }, n.show = function() {
                if (!(this._element.disabled || t(this._element).hasClass(ae) || t(this._menu).hasClass(re))) {
                    var i = {
                            relatedTarget: this._element
                        },
                        n = t.Event(se.SHOW, i),
                ...
                return e = a({}, this.constructor.Default, t(this._element).data(), e), o.typeCheckConfig(Z, e, this.constructor.DefaultType), e
                ...
                if (!i || 3 !== i.which && ("keyup" !== i.type || 9 === i.which))
                    for (var n = [].slice.call(document.querySelectorAll(le)), s = 0, a = n.length; s < a; s++) {
                ...
                if ((/input|textarea/i.test(i.target.tagName) ? !(32 === i.which || 27 !== i.which && (40 !== i.which && 38 !== i.which || t(i.target).closest(ce).length)) : ne.test(i.which)) && (i.preventDefault(), i.stopPropagation(), !this.disabled && !t(this).hasClass(ae))) {
    ...
    t(document).on(se.KEYDOWN_DATA_API, le, he._dataApiKeydownHandler).on(se.KEYDOWN_DATA_API, ce, he._dataApiKeydownHandler).on(se.CLICK_DATA_API + " " + se.KEYUP_DATA_API, he._clearMenus).on(se.CLICK_DATA_API, le, (function(e) {
            ...
            return i.toggle = function(e) {
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (t(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        this._isShown = !1;
                        var s = t(this._element).hasClass(xe);
                        if (s && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off(be.FOCUSIN), t(this._element).removeClass(Te), t(this._element).off(be.CLICK_DISMISS), t(this._dialog).off(be.MOUSEDOWN_DISMISS), s) {
                ...
                return e = a({}, ve, e), o.typeCheckConfig(pe, e, ye), e
            }, i._showElement = function(e) {
                var i = this,
                    n = t(this._element).hasClass(xe);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), t(this._dialog).hasClass("modal-dialog-scrollable") ? this._dialog.querySelector(".modal-body").scrollTop = 0 : this._element.scrollTop = 0, n && o.reflow(this._element), t(this._element).addClass(Te), this._config.focus && this._enforceFocus();
                ...
                if (n) {
                    ...
                    t(this._dialog).one(o.TRANSITION_END, a).emulateTransitionEnd(r)
                } else a()
                ...
                var i = this,
                    n = t(this._element).hasClass(xe) ? xe : "";
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", n && this._backdrop.classList.add(n), t(this._backdrop).appendTo(document.body), t(this._element).on(be.CLICK_DISMISS, (function(e) {
                        ...
                        })), n && o.reflow(this._backdrop), t(this._backdrop).addClass(Te), !e) return;
                    if (!n) return void e();
                    var s = o.getTransitionDurationFromElement(this._backdrop);
                    t(this._backdrop).one(o.TRANSITION_END, e).emulateTransitionEnd(s)
                    ...
                    if (t(this._element).hasClass(xe)) {
                        ...
                        t(this._backdrop).one(o.TRANSITION_END, a).emulateTransitionEnd(r)
                    } else a()
                } else e && e()
                ...
                return this.each((function() {
                    var s = t(this).data(fe),
                        r = a({}, ve, t(this).data(), "object" == typeof i && i ? i : {});
                    if (s || (s = new e(this, r), t(this).data(fe, s)), "string" == typeof i) {
                        if (void 0 === s[i]) throw new TypeError('No method named "' + i + '"');
                        s[i](n)
    ...
    t(document).on(be.CLICK_DATA_API, '[data-toggle="modal"]', (function(e) {
        ...
        var r = t(i).data(fe) ? "toggle" : a({}, t(i).data(), t(this).data());
        ...
        _e._jQueryInterface.call(t(i), r, this)
    })), t.fn[pe] = _e._jQueryInterface, t.fn[pe].Constructor = _e, t.fn[pe].noConflict = function() {
        return t.fn[pe] = ge, _e._jQueryInterface
    };
        ...
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), s = Object.keys(t), a = [].slice.call(n.body.querySelectorAll("*")), r = function(e, i) {
                ...
                o.forEach((function(e) {
                    (function(e, t) {
                        ...
                        if (-1 !== t.indexOf(i)) return -1 === ke.indexOf(i) || Boolean(e.nodeValue.match(Pe) || e.nodeValue.match(Me));
        ...
        Ve = function() {
            ...
            return n.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var s = o.findShadowRoot(this.element),
                    ...
                    r.setAttribute("id", l), this.element.setAttribute("aria-describedby", l), this.setContent(), this.config.animation && t(r).addClass(qe);
                    ...
                    }), t(r).addClass(We), "ontouchstart" in document.documentElement && t(document.body).children().on("mouseover", null, t.noop);
                    var h = function() {
                ...
                if (t(this.element).trigger(s), !s.isDefaultPrevented()) {
                    if (t(n).removeClass(We), "ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), this._activeTrigger.click = !1, this._activeTrigger[Ye] = !1, this._activeTrigger[Xe] = !1, t(this.tip).hasClass(qe)) {
                        var r = o.getTransitionDurationFromElement(n);
                        t(n).one(o.TRANSITION_END, a).emulateTransitionEnd(r)
                    } else a();
                    this._hoverState = ""
                }
            }, n.update = function() {
                ...
                t(this.getTipElement()).addClass(Ne + "-" + e)
            }, n.getTipElement = function() {
                return this.tip = this.tip || t(this.config.template)[0], this.tip
            }, n.setContent = function() {
                var e = this.getTipElement();
                this.setElementContent(t(e.querySelectorAll(".tooltip-inner")), this.getTitle()), t(e).removeClass(qe + " " + We)
                ...
                this.config.trigger.split(" ").forEach((function(i) {
                    if ("click" === i) t(e.element).on(e.constructor.Event.CLICK, e.config.selector, (function(t) {
                        ...
                        var n = i === Xe ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
                            s = i === Xe ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                ...
                var n = this.constructor.DATA_KEY;
                (i = i || t(e.currentTarget).data(n)) || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(n, i)), e && (i._activeTrigger["focusout" === e.type ? Ye : Xe] = !1), i._isWithActiveTrigger() || (clearTimeout(i._timeout), i._hoverState = "out", i.config.delay && i.config.delay.hide ? i._timeout = setTimeout((function() {
                ...
                return Object.keys(i).forEach((function(e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), o.typeCheckConfig(Ae, e, this.constructor.DefaultType), e.sanitize && (e.template = De(e.template, e.whiteList, e.sanitizeFn)), e
                ...
                return this.each((function() {
                    var n = t(this).data(Ie),
                        s = "object" == typeof i && i;
                    if ((n || !/dispose|hide/.test(i)) && (n || (n = new e(this, s), t(this).data(Ie, n)), "string" == typeof i)) {
                        if (void 0 === n[i]) throw new TypeError('No method named "' + i + '"');
                        n[i]()
                    }
                }))
    ...
    t.fn[Ae] = Ve._jQueryInterface, t.fn[Ae].Constructor = Ve, t.fn[Ae].noConflict = function() {
        return t.fn[Ae] = $e, Ve._jQueryInterface
    };
    var Ge = "popover",
        Ue = "bs.popover",
        Ke = "." + Ue,
        ...
        nt = function(e) {
            ...
            n = e, (i = a).prototype = Object.create(n.prototype), (i.prototype.constructor = i).__proto__ = n;
            var r = a.prototype;
            return r.isWithContent = function() {
                ...
                return this.each((function() {
                    var i = t(this).data(Ue),
                        n = "object" == typeof e ? e : null;
                    if ((i || !/dispose|hide/.test(e)) && (i || (i = new a(this, n), t(this).data(Ue, i)), "string" == typeof e)) {
    ...
    t.fn[Ge] = nt._jQueryInterface, t.fn[Ge].Constructor = nt, t.fn[Ge].noConflict = function() {
        return t.fn[Ge] = Qe, nt._jQueryInterface
    };
    var st = "scrollspy",
        at = "bs.scrollspy",
        rt = "." + at,
        ...
        vt = function() {
            ...
            return i.refresh = function() {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map((function(e) {
                    var i, a = o.getSelectorFromElement(e);
                ...
                t.removeData(this._element, at), t(this._scrollElement).off(rt), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, i._getConfig = function(e) {
                if ("string" != typeof(e = a({}, lt, "object" == typeof e && e ? e : {})).target) {
                    var i = t(e.target).attr("id");
                    i || (i = o.getUID(st), t(e.target).attr("id", i)), e.target = "#" + i
                }
                return o.typeCheckConfig(st, e, ct), e
                ...
                return this.each((function() {
                    ...
                    if (n || (n = new e(this, "object" == typeof i && i), t(this).data(at, n)), "string" == typeof i) {
                        if (void 0 === n[i]) throw new TypeError('No method named "' + i + '"');
                        n[i]()
                    }
                }))
    ...
    })), t.fn[st] = vt._jQueryInterface, t.fn[st].Constructor = vt, t.fn[st].noConflict = function() {
        return t.fn[st] = ot, vt._jQueryInterface
    };
    var yt = "bs.tab",
        bt = "." + yt,
        wt = t.fn.tab,
        ...
        St = function() {
            ...
            return i.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(Tt) || t(this._element).hasClass("disabled"))) {
                    ...
                    if (s) {
                        var r = "UL" === s.nodeName || "OL" === s.nodeName ? Ct : Et;
                        n = (n = t.makeArray(t(s).find(r)))[n.length - 1]
                    }
                    var l = t.Event(xt.HIDE, {
                            relatedTarget: this._element
                        }),
                        c = t.Event(xt.SHOW, {
                            relatedTarget: n
                ...
                var s = this,
                    a = (!i || "UL" !== i.nodeName && "OL" !== i.nodeName ? t(i).children(Et) : t(i).find(Ct))[0],
                ...
                if (i) {
                    ...
                    s && t(s).removeClass(Tt), "tab" === i.getAttribute("role") && i.setAttribute("aria-selected", !1)
                }
                if (t(e).addClass(Tt), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), o.reflow(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && t(e.parentNode).hasClass("dropdown-menu")) {
                    var a = t(e).closest(".dropdown")[0];
                    if (a) {
                        var r = [].slice.call(a.querySelectorAll(".dropdown-toggle"));
                        t(r).addClass(Tt)
                    }
                ...
                return this.each((function() {
                    var n = t(this),
                        s = n.data(yt);
                    if (s || (s = new e(this), n.data(yt, s)), "string" == typeof i) {
                        if (void 0 === s[i]) throw new TypeError('No method named "' + i + '"');
                        s[i]()
                    }
                }))
    ...
    var _t = "toast",
        ...
        Nt = function() {
            ...
            return i.show = function() {
                ...
                var i = function() {
                    e._element.classList.remove(It), e._element.classList.add(At), t(e._element).trigger(Dt.SHOWN), e._config.autohide && e.hide()
                };
                ...
                var i = this;
                this._element.classList.contains(At) && (t(this._element).trigger(Dt.HIDE), e ? this._close() : this._timeout = setTimeout((function() {
                    i._close()
                }), this._config.delay))
            }, i.dispose = function() {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(At) && this._element.classList.remove(At), t(this._element).off(Dt.CLICK_DISMISS), t.removeData(this._element, kt), this._element = null, this._config = null
            }, i._getConfig = function(e) {
                return e = a({}, $t, t(this._element).data(), "object" == typeof e && e ? e : {}), o.typeCheckConfig(_t, e, this.constructor.DefaultType), e
                ...
                return this.each((function() {
                    var n = t(this),
                        s = n.data(kt);
                    if (s || (s = new e(this, "object" == typeof i && i), n.data(kt, s)), "string" == typeof i) {
                        if (void 0 === s[i]) throw new TypeError('No method named "' + i + '"');
                        s[i](this)
                    }
                }))
    ...
    t.fn[_t] = Nt._jQueryInterface, t.fn[_t].Constructor = Nt, t.fn[_t].noConflict = function() {
            return t.fn[_t] = Mt, Nt._jQueryInterface
        },
        function() {
            if (void 0 === t) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
            var e = t.fn.jquery.split(" ")[0].split(".");
            if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || 4 <= e[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }(), e.Util = o, e.Alert = p, e.Button = E, e.Carousel = H, e.Collapse = Q, e.Dropdown = he, e.Modal = _e, e.Popover = nt, e.Scrollspy = vt, e.Tab = St, e.Toast = Nt, e.Tooltip = Ve, Object.defineProperty(e, "__esModule", {
            value: !0
        })
})),
function(e, t) {
        ...
        if (n)
            if ("string" == typeof n) {
                ...
                if (c.indexOf("<") >= 0 && c.indexOf(">") >= 0) {
                    ...
                    for (o = s || "#" !== n[0] || n.match(/[ .<>:~]/) ? (s || e).querySelectorAll(n.trim()) : [e.getElementById(n.trim().split("#")[1])], r = 0; r < o.length; r += 1) o[r] && a.push(o[r])
    ...
    var a = {
        ...
        find: function(e) {
            for (var t = [], n = 0; n < this.length; n += 1)
                for (var s = this[n].querySelectorAll(e), a = 0; a < s.length; a += 1) t.push(s[a]);
            return new i(t)
        },
        children: function(e) {
            for (var t = [], a = 0; a < this.length; a += 1)
                for (var r = this[a].childNodes, o = 0; o < r.length; o += 1) e ? 1 === r[o].nodeType && n(r[o]).is(e) && t.push(r[o]) : 1 === r[o].nodeType && t.push(r[o]);
            return new i(s(t))
        },
        filter: function(e) {
    ...
    var r = {
            ...
            extend: function() {
                ...
                for (var i = Object(e[0]), n = 1; n < e.length; n += 1) {
                    var s = e[n];
                    if (null != s)
                        for (var a = Object.keys(Object(s)), o = 0, l = a.length; o < l; o += 1) {
                            var c = a[o],
                                d = Object.getOwnPropertyDescriptor(s, c);
                            void 0 !== d && d.enumerable && (r.isObject(i[c]) && r.isObject(s[c]) ? r.extend(i[c], s[c]) : !r.isObject(i[c]) && r.isObject(s[c]) ? (i[c] = {}, r.extend(i[c], s[c])) : i[c] = s[c])
                        }
                }
                return i
            }
    ...
    l.prototype.on = function(e, t, i) {
        ...
        var s = e.name || Object.keys(n.prototype.modules).length + "_" + r.now();
    ...
    var d, u, h, p, f, m, g, v, y, b, w, x, T, E, C, S = {
            updateSize: function() {
                var e, t, i = this.$el;
            ...
            updateSlides: function() {
                ...
                if (void 0 !== n) {
                    ...
                    for (var S, _ = e.slidesPerColumn, k = E / _, P = Math.floor(d / e.slidesPerColumn), M = 0; M < d; M += 1) {
                        C = 0;
                        var D = c.eq(M);
                        if (e.slidesPerColumn > 1) {
                            ...
                            if ("row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                                var $ = Math.floor(M / (e.slidesPerGroup * e.slidesPerColumn)),
                                    N = M - e.slidesPerColumn * e.slidesPerGroup * $,
                                    O = 0 === $ ? e.slidesPerGroup : Math.min(Math.ceil((d - $ * _ * e.slidesPerGroup) / _), e.slidesPerGroup);
                                A = (I = N - (L = Math.floor(N / O)) * O + $ * e.slidesPerGroup) + L * E / _, D.css({
                            ...
                            } else "column" === e.slidesPerColumnFill ? (L = M - (I = Math.floor(M / _)) * _, (I > P || I === P && L === _ - 1) && (L += 1) >= _ && (L = 0, I += 1)) : I = M - (L = Math.floor(M / k)) * k;
                            D.css("margin-" + (this.isHorizontal() ? "top" : "left"), 0 !== L && e.spaceBetween && e.spaceBetween + "px")
                        }
                        if ("none" !== D.css("display")) {
                            if ("auto" === e.slidesPerView) {
                                ...
                                if (H && (D[0].style.transform = "none"), j && (D[0].style.webkitTransform = "none"), e.roundLengths) C = this.isHorizontal() ? D.outerWidth(!0) : D.outerHeight(!0);
                                    ...
                                    var F = parseFloat(z.getPropertyValue("width")),
                                        ...
                                        W = parseFloat(z.getPropertyValue("margin-right")),
                                        X = z.getPropertyValue("box-sizing");
                                    C = X && "border-box" === X ? F + q + W : F + B + R + q + W
                                } else {
                                    ...
                                    C = Q && "border-box" === Q ? Y + U + K : Y + V + G + U + K
                                }
                                H && (D[0].style.transform = H), j && (D[0].style.webkitTransform = j), e.roundLengths && (C = Math.floor(C))
                            } else C = (n - (e.slidesPerView - 1) * b) / e.slidesPerView, e.roundLengths && (C = Math.floor(C)), c[M] && (this.isHorizontal() ? c[M].style.width = C + "px" : c[M].style.height = C + "px");
                            c[M] && (c[M].swiperSlideSize = C), p.push(C), e.centeredSlides ? (w = w + C / 2 + x / 2 + b, 0 === x && 0 !== M && (w = w - n / 2 - b), 0 === M && (w = w - n / 2 - b), Math.abs(w) < .001 && (w = 0), e.roundLengths && (w = Math.floor(w)), T % e.slidesPerGroup == 0 && u.push(w), h.push(w)) : (e.roundLengths && (w = Math.floor(w)), T % e.slidesPerGroup == 0 && u.push(w), h.push(w), w = w + C + b), this.virtualSize += C + b, x = C, T += 1
                        }
                    }
                    if (this.virtualSize = Math.max(this.virtualSize, n) + g, s && a && ("slide" === e.effect || "coverflow" === e.effect) && i.css({
                    ...
                    if (!e.centeredSlides) {
                        ...
                        for (var ee = 0; ee < u.length; ee += 1) {
                            var te = u[ee];
                            e.roundLengths && (te = Math.floor(te)), u[ee] <= this.virtualSize - n && S.push(te)
                        }
                        u = S, Math.floor(this.virtualSize - n) - Math.floor(u[u.length - 1]) > 1 && u.push(this.virtualSize - n)
                    }
                    ...
                    r.extend(this, {
                        ...
                        slidesGrid: h,
                        slidesSizesGrid: p
                    }), d !== l && this.emit("slidesLengthChange"), u.length !== v && (this.params.watchOverflow && this.checkOverflow(), this.emit("snapGridLengthChange")), h.length !== y && this.emit("slidesGridLengthChange"), (e.watchSlidesProgress || e.watchSlidesVisibility) && this.updateSlidesOffset()
                }
            },
            ...
            updateProgress: function(e) {
                ...
                var i = this.params,
                    ...
                    l = a,
                    c = o;
                0 === n ? (s = 0, a = !0, o = !0) : (a = (s = (e - this.minTranslate()) / n) <= 0, o = s >= 1), r.extend(this, {
                    progress: s,
                    isBeginning: a,
                    isEnd: o
                }), (i.watchSlidesProgress || i.watchSlidesVisibility) && this.updateSlidesProgress(e), a && !l && this.emit("reachBeginning toEdge"), o && !c && this.emit("reachEnd toEdge"), (l && !a || c && !o) && this.emit("fromEdge"), this.emit("progress", s)
            },
            ...
            updateActiveIndex: function(e) {
                ...
                if ((t = s.indexOf(i) >= 0 ? s.indexOf(i) : Math.floor(d / a.slidesPerGroup)) >= s.length && (t = s.length - 1), d !== o) {
        ...
        _ = {
            ...
            translateTo: function(e, t, i, n, s) {
                ...
                var c, d = r.minTranslate(),
                    u = r.maxTranslate();
                if (c = n && e > d ? d : n && e < u ? u : e, r.updateProgress(c), o.cssMode) {
                    var h = r.isHorizontal();
                    return 0 === t ? l[h ? "scrollLeft" : "scrollTop"] = -c : l.scrollTo ? l.scrollTo(((a = {})[h ? "left" : "top"] = -c, a.behavior = "smooth", a)) : l[h ? "scrollLeft" : "scrollTop"] = -c, !0
                }
        ...
        k = {
            slideTo: function(e, t, i, n) {
                ...
                f >= l.length && (f = l.length - 1), (u || o.initialSlide || 0) === (d || 0) && i && a.emit("beforeSlideChangeStart");
                var m, g = -l[f];
                if (a.updateProgress(g), o.normalizeSlideIndex)
                    for (var v = 0; v < c.length; v += 1) - Math.floor(100 * g) >= Math.floor(100 * c[v]) && (r = v);
                if (a.initialized && r !== u) {
                    if (!a.allowSlideNext && g < a.translate && g < a.minTranslate()) return !1;
                    if (!a.allowSlidePrev && g > a.translate && g > a.maxTranslate() && (u || 0) !== r) return !1
                }
                if (m = r > u ? "next" : r < u ? "prev" : "reset", h && -g === a.translate || !h && g === a.translate) return a.updateActiveIndex(r), o.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== o.effect && a.setTranslate(g), "reset" !== m && (a.transitionStart(i, m), a.transitionEnd(i, m)), !1;
                if (o.cssMode) {
            ...
            slidePrev: function(e, t, i) {
                ...
                return void 0 === h && n.cssMode && a.forEach((function(e) {
                    !h && d >= e && (h = e)
                })), void 0 !== h && (c = r.indexOf(h)) < 0 && (c = this.activeIndex - 1), this.slideTo(c, e, t, i)
            },
            ...
            slideToClosest: function(e, t, i, n) {
                ...
                if (r >= this.snapGrid[a]) {
                    ...
                    r - o > (this.snapGrid[a + 1] - o) * n && (s += this.params.slidesPerGroup)
                } else {
                    var l = this.snapGrid[a - 1];
                    r - l <= (this.snapGrid[a] - l) * n && (s -= this.params.slidesPerGroup)
                }
            ...
            slideToClickedSlide: function() {
                ...
                if (i.loop) {
                    ...
                    e = parseInt(n(t.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? o < t.loopedSlides - a / 2 || o > t.slides.length - t.loopedSlides + a / 2 ? (t.loopFix(), o = s.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), r.nextTick((function() {
                        t.slideTo(o)
                    }))) : t.slideTo(o) : o > t.slides.length - a ? (t.loopFix(), o = s.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), r.nextTick((function() {
                        t.slideTo(o)
                    }))) : t.slideTo(o)
                } else t.slideTo(o)
            }
        ...
        P = {
            loopCreate: function() {
                ...
                a.each((function(e, i) {
                    var s = n(i);
                    e < t.loopedSlides && d.push(i), e < a.length && e >= a.length - t.loopedSlides && c.push(i), s.attr("data-swiper-slide-index", e)
                }));
        ...
        D = {
            ...
            addSlide: function(e, t) {
                ...
                if (e <= 0) this.prependSlide(t);
                    ...
                    n.loop && this.loopCreate(), n.observer && o.observer || this.update(), n.loop ? this.slideTo(r + this.loopedSlides, 0, !1) : this.slideTo(r, 0, !1)
                }
            },
        ...
        A = (d = t.navigator.platform, u = t.navigator.userAgent, h = {
            ios: !1,
            android: !1,
            androidChrome: !1,
            desktop: !1,
            ...
            if (("wrapper" !== a.touchEventsTarget || c.closest(this.wrapperEl).length) && (s.isTouchEvent = "touchstart" === l.type, (s.isTouchEvent || !("which" in l) || 3 !== l.which) && !(!s.isTouchEvent && "button" in l && l.button > 0 || s.isTouched && s.isMoved)))
                ...
                if (!h || !(d <= p || d >= t.screen.width - p)) {
                    if (r.extend(s, {
                            ...
                            isScrolling: void 0,
                            startMoving: void 0
                        }), o.startX = d, o.startY = u, s.touchStartTime = r.now(), this.allowClick = !0, this.updateSize(), this.swipeDirection = void 0, a.threshold > 0 && (s.allowThresholdMove = !1), "touchstart" !== l.type) {
                        var f = !0;
            ...
            if (!i.isTouchEvent || "mousemove" !== l.type) {
                ...
                if (i.allowTouchCallbacks && this.emit("touchMove", l), !(l.targetTouches && l.targetTouches.length > 1)) {
                    ...
                    if (!(this.params.threshold && Math.sqrt(Math.pow(p, 2) + Math.pow(f, 2)) < this.params.threshold))
                        if (void 0 === i.isScrolling && (this.isHorizontal() && a.currentY === a.startY || this.isVertical() && a.currentX === a.startX ? i.isScrolling = !1 : p * p + f * f >= 25 && (h = 180 * Math.atan2(Math.abs(f), Math.abs(p)) / Math.PI, i.isScrolling = this.isHorizontal() ? h > s.touchAngle : 90 - h > s.touchAngle)), i.isScrolling && this.emit("touchMoveOpposite", l), void 0 === i.startMoving && (a.currentX === a.startX && a.currentY === a.startY || (i.startMoving = !0)), i.isScrolling) i.isTouched = !1;
                        ...
                        a.diff = m, m *= s.touchRatio, o && (m = -m), this.swipeDirection = m > 0 ? "prev" : "next", i.currentTranslate = m + i.startTranslate;
                        var g = !0,
                            v = s.resistanceRatio;
    ...
    function $(e) {
        ...
        if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap click", d), p < 300 && h - i.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)), i.lastClickTime = r.now(), r.nextTick((function() {
        ...
        if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, u = n.followFinger ? a ? t.translate : -t.translate : -i.currentTranslate, !n.cssMode)
            if (n.freeMode) {
                ...
                if (n.freeModeMomentum) {
                    if (i.velocities.length > 1) {
                        var f = i.velocities.pop(),
                            ...
                            v = f.time - m.time;
                        t.velocity = g / v, t.velocity /= 2, Math.abs(t.velocity) < n.freeModeMinimumVelocity && (t.velocity = 0), (v > 150 || r.now() - f.time > 300) && (t.velocity = 0)
                    } else t.velocity = 0;
                    ...
                    if (w < t.maxTranslate()) n.freeModeMomentumBounce ? (w + t.maxTranslate() < -C && (w = t.maxTranslate() - C), x = t.maxTranslate(), E = !0, i.allowMomentumBounce = !0) : w = t.maxTranslate(), n.loop && n.centeredSlides && (T = !0);
                    else if (w > t.minTranslate()) n.freeModeMomentumBounce ? (w - t.minTranslate() > C && (w = t.minTranslate() + C), x = t.minTranslate(), E = !0, i.allowMomentumBounce = !0) : w = t.minTranslate(), n.loop && n.centeredSlides && (T = !0);
                    else if (n.freeModeSticky) {
                        for (var S, _ = 0; _ < c.length; _ += 1)
                            if (c[_] > -w) {
                                S = _;
                                break
                            }
                        w = -(w = Math.abs(c[S] - w) < Math.abs(c[S - 1] - w) || "next" === t.swipeDirection ? c[S] : c[S - 1])
                    }
                    if (T && t.once("transitionEnd", (function() {
                        ...
                        if (y = a ? Math.abs((-w - t.translate) / t.velocity) : Math.abs((w - t.translate) / t.velocity), n.freeModeSticky) {
                            ...
                            y = k < P ? n.speed : k < 2 * P ? 1.5 * n.speed : 2.5 * n.speed
                        }
                ...
                for (var M = 0, D = t.slidesSizesGrid[0], A = 0; A < l.length; A += n.slidesPerGroup) void 0 !== l[A + n.slidesPerGroup] ? u >= l[A] && u < l[A + n.slidesPerGroup] && (M = A, D = l[A + n.slidesPerGroup] - l[A]) : u >= l[A] && (M = A, D = l[l.length - 1] - l[l.length - 2]);
                var I = (u - l[M]) / D;
                if (p > n.longSwipesMs) {
                    if (!n.longSwipes) return void t.slideTo(t.activeIndex);
                    "next" === t.swipeDirection && (I >= n.longSwipesRatio ? t.slideTo(M + n.slidesPerGroup) : t.slideTo(M)), "prev" === t.swipeDirection && (I > 1 - n.longSwipesRatio ? t.slideTo(M + n.slidesPerGroup) : t.slideTo(M))
                } else {
                    if (!n.shortSwipes) return void t.slideTo(t.activeIndex);
                    !t.navigation || d.target !== t.navigation.nextEl && d.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(M + n.slidesPerGroup), "prev" === t.swipeDirection && t.slideTo(M)) : d.target === t.navigation.nextEl ? t.slideTo(M + n.slidesPerGroup) : t.slideTo(M)
                }
            }
    }
    ...
    var F = {
            ...
            events: {
                attachEvents: function() {
                    var t = this.params,
                        ...
                        n = this.el,
                        s = this.wrapperEl;
                    this.onTouchStart = I.bind(this), this.onTouchMove = L.bind(this), this.onTouchEnd = $.bind(this), t.cssMode && (this.onScroll = z.bind(this)), this.onClick = O.bind(this);
                    var a = !!t.nested;
                    if (!o.touch && o.pointerEvents) n.addEventListener(i.start, this.onTouchStart, !1), e.addEventListener(i.move, this.onTouchMove, a), e.addEventListener(i.end, this.onTouchEnd, !1);
                    else {
                        if (o.touch) {
                            ...
                            n.addEventListener(i.start, this.onTouchStart, r), n.addEventListener(i.move, this.onTouchMove, o.passiveListener ? {
                                passive: !1,
                                capture: a
                            } : a), n.addEventListener(i.end, this.onTouchEnd, r), i.cancel && n.addEventListener(i.cancel, this.onTouchEnd, r), H || (e.addEventListener("touchstart", j), H = !0)
                        }(t.simulateTouch && !A.ios && !A.android || t.simulateTouch && !o.touch && A.ios) && (n.addEventListener("mousedown", this.onTouchStart, !1), e.addEventListener("mousemove", this.onTouchMove, a), e.addEventListener("mouseup", this.onTouchEnd, !1))
                    }(t.preventClicks || t.preventClicksPropagation) && n.addEventListener("click", this.onClick, !0), t.cssMode && s.addEventListener("scroll", this.onScroll), t.updateOnWindowResize ? this.on(A.ios || A.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", N, !0) : this.on("observerUpdate", N, !0)
                },
                detachEvents: function() {
                    var t = this.params,
                        ...
                        s = this.wrapperEl,
                        a = !!t.nested;
                    if (!o.touch && o.pointerEvents) n.removeEventListener(i.start, this.onTouchStart, !1), e.removeEventListener(i.move, this.onTouchMove, a), e.removeEventListener(i.end, this.onTouchEnd, !1);
                    else {
                        if (o.touch) {
                            ...
                            n.removeEventListener(i.start, this.onTouchStart, r), n.removeEventListener(i.move, this.onTouchMove, a), n.removeEventListener(i.end, this.onTouchEnd, r), i.cancel && n.removeEventListener(i.cancel, this.onTouchEnd, r)
                        }(t.simulateTouch && !A.ios && !A.android || t.simulateTouch && !o.touch && A.ios) && (n.removeEventListener("mousedown", this.onTouchStart, !1), e.removeEventListener("mousemove", this.onTouchMove, a), e.removeEventListener("mouseup", this.onTouchEnd, !1))
                    }(t.preventClicks || t.preventClicksPropagation) && n.removeEventListener("click", this.onClick, !0), t.cssMode && s.removeEventListener("scroll", this.onScroll), this.off(A.ios || A.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", N)
                }
            },
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    if (a && (!a || 0 !== Object.keys(a).length)) {
                        ...
                        if (o && this.currentBreakpoint !== o) {
                            ...
                            h && t && this.changeDirection(), r.extend(this.params, c), r.extend(this, {
        ...
        q = function(e) {
            function t() {
                for (var i, s, a, l = [], c = arguments.length; c--;) l[c] = arguments[c];
                1 === l.length && l[0].constructor && l[0].constructor === Object ? a = l[0] : (s = (i = l)[0], a = i[1]), a || (a = {}), a = r.extend({}, a), s && !a.el && (a.el = s), e.call(this, a), Object.keys(B).forEach((function(e) {
                ...
                var u = r.extend({}, F);
                d.useModulesParams(u), d.params = r.extend({}, u, R, a), d.originalParams = r.extend({}, d.params), d.passedParams = r.extend({}, a), d.$ = n;
                var h = n(d.params.el);
                if (s = h[0]) {
                    if (h.length > 1) {
                        var p = [];
                    ...
                    var f, m, g;
                    return s.swiper = d, h.data("swiper", d), s && s.shadowRoot && s.shadowRoot.querySelector ? (f = n(s.shadowRoot.querySelector("." + d.params.wrapperClass))).children = function(e) {
                        return h.children(e)
                    } : f = h.children("." + d.params.wrapperClass), r.extend(d, {
                        $el: h,
                        el: s,
                        $wrapperEl: f,
                        wrapperEl: f[0],
        ...
        Q = {
            update: function(e) {
                ...
                v = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", a ? (y = Math.floor(n / 2) + s + l, b = Math.floor(n / 2) + s + c) : (y = n + (s - 1) + l, b = s + c);
                ...
                if (r.extend(t.virtual, {
                    ...
                    }), u === x && h === T && !e) return t.slidesGrid !== f && E !== g && t.slides.css(v, E + "px"), void t.updateProgress();
                ...
                if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
                    ...
                    for (var k = u; k <= h; k += 1)(k < x || k > T) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + k + '"]').remove();
                for (var P = 0; P < p.length; P += 1) P >= x && P <= T && (void 0 === h || e ? _.push(P) : (P > h && _.push(P), P < u && S.push(P)));
                    ...
                    if (!d) {
                        ...
                        if (u >= i.minTranslate() && (u = i.minTranslate()), u <= i.maxTranslate() && (u = i.maxTranslate()), i.setTransition(0), i.setTranslate(u), i.updateProgress(), i.updateActiveIndex(), i.updateSlidesClasses(), (!h && i.isBeginning || !p && i.isEnd) && i.updateSlidesClasses(), i.params.freeModeSticky) {
                            ...
                            if (f.push(l), m && (l.delta > m.delta || l.direction !== m.direction)) f.splice(0);
                                ...
                                var v = s > 0 ? .8 : .2;
                                i.mousewheel.lastEventBeforeSnap = l, f.splice(0), i.mousewheel.timeout = r.nextTick((function() {
            ...
            update: function() {
                ...
                if (t.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                    ...
                    if (this.params.loop ? ((i = Math.ceil((this.activeIndex - this.loopedSlides) / this.params.slidesPerGroup)) > s - 1 - 2 * this.loopedSlides && (i -= s - 2 * this.loopedSlides), i > r - 1 && (i -= r), i < 0 && "bullets" !== this.params.paginationType && (i = r + i)) : i = void 0 !== this.snapIndex ? this.snapIndex : this.activeIndex || 0, "bullets" === t.type && this.pagination.bullets && this.pagination.bullets.length > 0) {
                        ...
                        if (t.dynamicBullets && (this.pagination.bulletSize = d.eq(0)[this.isHorizontal() ? "outerWidth" : "outerHeight"](!0), a.css(this.isHorizontal() ? "width" : "height", this.pagination.bulletSize * (t.dynamicMainBullets + 4) + "px"), t.dynamicMainBullets > 1 && void 0 !== this.previousIndex && (this.pagination.dynamicBulletIndex += i - this.previousIndex, this.pagination.dynamicBulletIndex > t.dynamicMainBullets - 1 ? this.pagination.dynamicBulletIndex = t.dynamicMainBullets - 1 : this.pagination.dynamicBulletIndex < 0 && (this.pagination.dynamicBulletIndex = 0)), o = i - this.pagination.dynamicBulletIndex, c = ((l = o + (Math.min(d.length, t.dynamicMainBullets) - 1)) + o) / 2), d.removeClass(t.bulletActiveClass + " " + t.bulletActiveClass + "-next " + t.bulletActiveClass + "-next-next " + t.bulletActiveClass + "-prev " + t.bulletActiveClass + "-prev-prev " + t.bulletActiveClass + "-main"), a.length > 1) d.each((function(e, s) {
                            var a = n(s),
                                r = a.index();
                    ...
                    if ("fraction" === t.type && (a.find("." + t.currentClass).text(t.formatFractionCurrent(i + 1)), a.find("." + t.totalClass).text(t.formatFractionTotal(r))), "progressbar" === t.type) {
                        ...
                        var x = (i + 1) / r,
                            T = 1,
                            E = 1;
                        "horizontal" === w ? T = x : E = x, a.find("." + t.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + T + ") scaleY(" + E + ")").transition(this.params.speed)
                    }
        ...
        se = {
            ...
            updateSize: function() {
                if (this.params.scrollbar.el && this.scrollbar.el) {
                    ...
                    var n, s = this.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight,
                        ...
                        o = a * (s / this.size);
                    n = "auto" === this.params.scrollbar.dragSize ? s * a : parseInt(this.params.scrollbar.dragSize, 10), this.isHorizontal() ? t[0].style.width = n + "px" : t[0].style.height = n + "px", i[0].style.display = a >= 1 ? "none" : "", this.params.scrollbar.hide && (i[0].style.opacity = 0), r.extend(e, {
                        trackSize: s,
                        divider: a,
                        moveDivider: o,
                        dragSize: n
            ...
            onDragEnd: function(e) {
                var t = this.params.scrollbar,
                    ...
                    n = this.$wrapperEl,
                    s = i.$el;
                this.scrollbar.isTouched && (this.scrollbar.isTouched = !1, this.params.cssMode && (this.$wrapperEl.css("scroll-snap-type", ""), n.transition("")), t.hide && (clearTimeout(this.scrollbar.dragTimeout), this.scrollbar.dragTimeout = r.nextTick((function() {
            ...
            enableDraggable: function() {
                if (this.params.scrollbar.el) {
                    ...
                    o.touch ? (a.addEventListener(i.start, this.scrollbar.onDragStart, r), a.addEventListener(i.move, this.scrollbar.onDragMove, r), a.addEventListener(i.end, this.scrollbar.onDragEnd, l)) : (a.addEventListener(n.start, this.scrollbar.onDragStart, r), e.addEventListener(n.move, this.scrollbar.onDragMove, r), e.addEventListener(n.end, this.scrollbar.onDragEnd, l))
                }
            },
            disableDraggable: function() {
                if (this.params.scrollbar.el) {
                    ...
                    o.touch ? (a.removeEventListener(i.start, this.scrollbar.onDragStart, r), a.removeEventListener(i.move, this.scrollbar.onDragMove, r), a.removeEventListener(i.end, this.scrollbar.onDragEnd, l)) : (a.removeEventListener(n.start, this.scrollbar.onDragStart, r), e.removeEventListener(n.move, this.scrollbar.onDragMove, r), e.removeEventListener(n.end, this.scrollbar.onDragEnd, l))
                }
            },
            init: function() {
                if (this.params.scrollbar.el) {
                    ...
                    0 === a.length && (a = n('<div class="' + this.params.scrollbar.dragClass + '"></div>'), s.append(a)), r.extend(e, {
                        $el: s,
                        el: s[0],
                        $dragEl: a,
                        dragEl: a[0]
        ...
        re = {
            ...
            in: function(e) {
                var t, i, s, a, r, o, l, c, d, u, h, p, f, m, g, v, y = this.zoom,
                    b = this.params.zoom,
                    w = y.gesture,
                    x = y.image;
            ...
            load: function() {
                ...
                if (o.loadPrevNext)
                    if (l > 1 || o.loadPrevNextAmount && o.loadPrevNextAmount > 1) {
                        for (var h = o.loadPrevNextAmount, p = l, f = Math.min(a + p + Math.max(h, p), s.length), m = Math.max(a - Math.max(p, h), 0), g = a + l; g < f; g += 1) c(g) && e.lazy.loadInSlide(g);
        ...
        le = {
            ...
            setTranslate: function(e, t) {
                ...
                if (Array.isArray(a))
                    for (var o = 0; o < a.length; o += 1) a[o] !== t && a[o] instanceof q && r(a[o]);
            ...
            setTransition: function(e, t) {
                ...
                function a(t) {
                    t.setTransition(e, n), 0 !== e && (t.transitionStart(), t.params.autoHeight && r.nextTick((function() {
                        t.updateAutoHeight()
                ...
                if (Array.isArray(s))
                    for (i = 0; i < s.length; i += 1) s[i] !== t && s[i] instanceof q && a(s[i]);
                else s instanceof q && t !== s && a(s)
            }
        },
        ce = {
        ...
        de = {
            ...
            setHistory: function(e, i) {
                if (this.history.initialized && this.params.history.enabled) {
                    ...
                    a && a.value === s || (this.params.history.replaceState ? t.history.replaceState({
                        value: s
            ...
            setTranslate: function() {
                ...
                for (var p = 0; p < s.length; p += 1) {
                    ...
                    if (y <= 1 && y > -1 && (h = 90 * m + 90 * y, o && (h = 90 * -m - 90 * y)), f.transform(T), c.slideShadows) {
                        ...
                        0 === E.length && (E = n('<div class="swiper-slide-shadow-' + (d ? "left" : "top") + '"></div>'), f.append(E)), 0 === C.length && (C = n('<div class="swiper-slide-shadow-' + (d ? "right" : "bottom") + '"></div>'), f.append(C)), E.length && (E[0].style.opacity = Math.max(-y, 0)), C.length && (C[0].style.opacity = Math.max(y, 0))
                    }
                }
                if (i.css({
                ...
                var D = Y.isSafari || Y.isUiWebView ? -l / 2 : 0;
            ...
            setTranslate: function() {
                for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                    ...
                    if (this.isHorizontal() ? t && (r = -r) : (c = l, l = 0, o = -r, r = 0), s[0].style.zIndex = -Math.abs(Math.round(a)) + e.length, this.params.flipEffect.slideShadows) {
                        ...
                        0 === d.length && (d = n('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'), s.append(d)), 0 === u.length && (u = n('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'), s.append(u)), d.length && (d[0].style.opacity = Math.max(-a, 0)), u.length && (u[0].style.opacity = Math.max(a, 0))
                    }
        ...
        ge = {
            setTranslate: function() {
                for (var e = this.width, t = this.height, i = this.slides, s = this.$wrapperEl, a = this.slidesSizesGrid, r = this.params.coverflowEffect, l = this.isHorizontal(), c = this.translate, d = l ? e / 2 - c : t / 2 - c, u = l ? r.rotate : -r.rotate, h = r.depth, p = 0, f = i.length; p < f; p += 1) {
                    var m = i.eq(p),
                        g = a[p],
                    ...
                    if (m.transform(E), m[0].style.zIndex = 1 - Math.abs(Math.round(v)), r.slideShadows) {
                        ...
                        0 === C.length && (C = n('<div class="swiper-slide-shadow-' + (l ? "left" : "top") + '"></div>'), m.append(C)), 0 === S.length && (S = n('<div class="swiper-slide-shadow-' + (l ? "right" : "bottom") + '"></div>'), m.append(S)), C.length && (C[0].style.opacity = v > 0 ? v : 0), S.length && (S[0].style.opacity = -v > 0 ? -v : 0)
                    }
                }(o.pointerEvents || o.prefixedPointerEvents) && (s[0].style.perspectiveOrigin = d + "px 50%")
            },
            setTransition: function(e) {
    ...
    return void 0 === q.use && (q.use = q.Class.use, q.installModule = q.Class.installModule), q.use(ye), q
})),
function(e, t) {
    ...
    return function(e) {
        ...
        e.exports = {
            init: function(e) {
                ...
                }), m.throttleDelay)), m.disableMutationObserver || (0, l.default)("[data-aos]", v), p)
            },
            refresh: g,
            refreshHard: v
        }
        ...
        (function(t) {
            ...
            function i(e, t, i) {
                ...
                function r(e) {
                    var i = e - g;
                    return void 0 === g || i >= t || i < 0 || T && e - v >= p
                }
                ...
                function l() {
                    ...
                    return r(e) ? c(e) : void(m = setTimeout(l, function(e) {
                        var i = t - (e - g);
                        return T ? w(i, p - (e - v)) : i
                    }(e)))
                }

                function c(e) {
                    return m = void 0, E && u ? s(e) : (u = h = void 0, f)
                }
                ...
                function d() {
                    ...
                    if (u = arguments, h = this, g = e, i) {
                        ...
                        if (T) return m = setTimeout(l, t), s(g)
                    }
                ...
                return t = a(t) || 0, n(i) && (y = !!i.leading, p = (T = "maxWait" in i) ? b(a(i.maxWait) || 0, t) : p, E = "trailing" in i ? !!i.trailing : E), d.cancel = function() {
            ...
            e.exports = function(e, t, n) {
                ...
                function l() {
                    ...
                    return o(e) ? c(e) : void(m = setTimeout(l, function(e) {
                        var i = t - (e - g);
                        return T ? b(i, p - (e - v)) : i
                    }(e)))
                }

                function c(e) {
                    return m = void 0, E && u ? a(e) : (u = h = void 0, f)
                }
                ...
                function d() {
                    ...
                    if (u = arguments, h = this, g = e, i) {
                        if (void 0 === m) return function(e) {
                            return v = e, m = setTimeout(l, t), x ? a(e) : f
                        }(g);
                        if (T) return m = setTimeout(l, t), a(g)
                    }
                    return void 0 === m && (m = setTimeout(l, t)), f
                }
                var u, h, p, f, m, g, v = 0,
                ...
                return t = s(t) || 0, i(n) && (x = !!n.leading, p = (T = "maxWait" in n) ? y(s(n.maxWait) || 0, t) : p, E = "trailing" in n ? !!n.trailing : E), d.cancel = function() {
                    void 0 !== m && clearTimeout(m), v = 0, u = g = h = m = void 0
                }, d.flush = function() {
        ...
        t.default = function(e, t) {
            var s = window.document,
                a = new(window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver)(i);
            n = t, a.observe(s.documentElement, {
                childList: !0,
                subtree: !0,
                removedNodes: !0
            })
...
function(e, t, i, n) {
    ...
    function s(e, t) {
        var n, s, a, r = [],
            o = 0;
        e && e.isDefaultPrevented() || (e.preventDefault(), t = t || {}, e && e.data && (t = p(e.data.options, t)), n = t.$target || i(e.currentTarget).trigger("blur"), (a = i.fancybox.getInstance()) && a.$trigger && a.$trigger.is(n) || (t.selector ? r = i(t.selector) : (s = n.attr("data-fancybox") || "") ? r = (r = e.data ? e.data.items : []).length ? r.filter('[data-fancybox="' + s + '"]') : i('[data-fancybox="' + s + '"]') : r = [n], (o = i(r).index(n)) < 0 && (o = 0), (a = i.fancybox.open(r, t, o)).$trigger = n))
    }
    if (e.console = e.console || {
        ...
        var a = {
            ...
            m = function(e, t, n) {
                ...
                s.opts = p({
                    index: n
                }, i.fancybox.defaults), i.isPlainObject(t) && (s.opts = p(s.opts, t)), i.fancybox.isMobile && (s.opts = p(s.opts, s.opts.mobile)), s.id = s.opts.id || ++l, s.currIndex = parseInt(s.opts.index, 10) || 0, s.prevIndex = null, s.prevPos = null, s.currPos = 0, s.firstRun = !0, s.group = [], s.slides = {}, s.addContent(e), s.group.length && s.init()
            };
        i.extend(m.prototype, {
                ...
                addEvents: function() {
                    ...
                    t.removeEvents(), t.$refs.container.on("click.fb-close", "[data-fancybox-close]", (function(e) {
                        ...
                        var n = (i.fancybox ? i.fancybox.getInstance() : null).current,
                            s = e.keyCode || e.which;
                        if (9 != s) return !n.opts.keyboard || e.ctrlKey || e.altKey || e.shiftKey || i(e.target).is("input,textarea,video,audio,select") ? void 0 : 8 === s || 27 === s ? (e.preventDefault(), void t.close(e)) : 37 === s || 38 === s ? (e.preventDefault(), void t.previous()) : 39 === s || 40 === s ? (e.preventDefault(), void t.next()) : void t.trigger("afterKeydown", e, s);
                ...
                jumpTo: function(e, t) {
                    ...
                    if (!(p.isDragging || p.isClosing || p.isAnimating && p.firstRun)) {
                        ...
                        })), o.pos !== r.pos && (o.isComplete = !1), o.$slide.removeClass("fancybox-slide--complete fancybox-slide--current"), s ? (u = l.left - (o.pos * l.width + o.pos * o.opts.gutter), i.each(p.slides, (function(e, n) {
                ...
                createSlide: function(e) {
                    var t, n, s = this;
                    return n = (n = e % s.group.length) < 0 ? s.group.length + n : n, !s.slides[e] && s.group[n] && (t = i('<div class="fancybox-slide"></div>').appendTo(s.$refs.stage), s.slides[e] = i.extend(!0, {}, s.group[n], {
                        pos: e,
                        $slide: t,
                        isLoaded: !1
                ...
                scaleToActual: function(e, t, n) {
                    var s, a, r, o, l, c = this,
                        ...
                        f = d.width,
                        m = d.height;
                    c.isAnimating || c.isMoved() || !u || "image" != d.type || !d.isLoaded || d.hasError || (c.isAnimating = !0, i.fancybox.stop(u), e = void 0 === e ? .5 * h : e, t = void 0 === t ? .5 * p : t, (s = i.fancybox.getTranslate(u)).top -= i.fancybox.getTranslate(d.$slide).top, s.left -= i.fancybox.getTranslate(d.$slide).left, o = f / s.width, l = m / s.height, a = .5 * h - .5 * f, r = .5 * p - .5 * m, f > h && ((a = s.left * o - (e * o - e)) > 0 && (a = 0), a < h - f && (a = h - f)), m > p && ((r = s.top * l - (t * l - t)) > 0 && (r = 0), r < p - m && (r = p - m)), c.updateCursor(f, m), i.fancybox.animate(u, {
                        top: r,
                        left: a,
                        scaleX: o,
                        scaleY: l
                ...
                updateCursor: function(e, t) {
                    var n, s, a = this,
                        r = a.current,
                        o = a.$refs.container;
                    r && !a.isClosing && a.Guestures && (o.removeClass("fancybox-is-zoomable fancybox-can-zoomIn fancybox-can-zoomOut fancybox-can-swipe fancybox-can-pan"), s = !!(n = a.canPan(e, t)) || a.isZoomable(), o.toggleClass("fancybox-is-zoomable", s), i("[data-fancybox-zoom]").prop("disabled", !s), n ? o.addClass("fancybox-can-pan") : s && ("zoom" === r.opts.clickContent || i.isFunction(r.opts.clickContent) && "zoom" == r.opts.clickContent(r)) ? o.addClass("fancybox-can-zoomIn") : r.opts.touch && (r.opts.touch.vertical || a.group.length > 1) && "video" !== r.contentType && o.addClass("fancybox-can-swipe"))
                },
                isZoomable: function() {
                    var e, t = this,
                        i = t.current;
                ...
                setBigImage: function(e) {
                    ...
                    e.$image = a.one("error", (function() {
                        ...
                        var t;
                        e.$ghost || (n.resolveImageSlideSize(e, this.naturalWidth, this.naturalHeight), n.afterLoad(e)), n.isClosing || (e.opts.srcset && ((t = e.opts.sizes) && "auto" !== t || (t = (e.width / e.height > 1 && r.width() / r.height() > 1 ? "100" : Math.round(e.width / e.height * 100)) + "vw"), a.attr("sizes", t).attr("srcset", e.opts.srcset)), e.$ghost && setTimeout((function() {
                ...
                adjustCaption: function(e) {
                    var t, i = this,
                        ...
                        r = i.$refs.caption,
                        o = !1;
                    r.toggleClass("fancybox-caption--separate", a), a && s && s.length && (n.pos !== i.currPos ? ((t = r.clone().appendTo(r.parent())).children().eq(0).empty().html(s), o = t.outerHeight(!0), t.empty().remove()) : i.$caption && (o = i.$caption.outerHeight(!0)), n.$slide.css("padding-bottom", o || ""))
                },
                ...
                revealContent: function(e) {
                    var t, n, s, a, r = this,
                        ...
                        d = r.isMoved(e),
                        u = e.isRevealed;
                    return e.isRevealed = !0, t = e.opts[r.firstRun ? "animationEffect" : "transitionEffect"], s = e.opts[r.firstRun ? "animationDuration" : "transitionDuration"], s = parseInt(void 0 === e.forcedDuration ? s : e.forcedDuration, 10), !d && e.pos === r.currPos && s || (t = !1), "zoom" === t && (e.pos === r.currPos && s && "image" === e.type && !e.hasError && (c = r.getThumbPos(e)) ? l = r.getFitPos(e) : t = "fade"), "zoom" === t ? (r.isAnimating = !0, l.scaleX = l.width / c.width, l.scaleY = l.height / c.height, "auto" == (a = e.opts.zoomOpacity) && (a = Math.abs(e.width / e.height - c.width / c.height) > .1), a && (c.opacity = .1, l.opacity = 1), i.fancybox.setTranslate(e.$content.removeClass("fancybox-is-hidden"), c), h(e.$content), void i.fancybox.animate(e.$content, l, s, (function() {
                        r.isAnimating = !1, r.complete()
                    }))) : (r.updateSlide(e), t ? (i.fancybox.stop(o), n = "fancybox-slide--" + (e.pos >= r.prevPos ? "next" : "previous") + " fancybox-animated fancybox-fx-" + t, o.addClass(n).removeClass("fancybox-slide--current"), e.$content.removeClass("fancybox-is-hidden"), h(o), "image" !== e.type && e.$content.hide().show(0), void i.fancybox.animate(o, "fancybox-slide--current", s, (function() {
                        o.removeClass(n).css({
                            transform: "",
                            opacity: ""
                ...
                getThumbPos: function(e) {
                    var t, n, s, a, r, o = !1,
                        l = e.$thumb;
                    return !(!l || !f(l[0])) && (t = i.fancybox.getTranslate(l), n = parseFloat(l.css("border-top-width") || 0), s = parseFloat(l.css("border-right-width") || 0), a = parseFloat(l.css("border-bottom-width") || 0), r = parseFloat(l.css("border-left-width") || 0), o = {
                        top: t.top + n,
                        left: t.left + r,
                        width: t.width - s - r,
                        height: t.height - n - a,
                ...
                focus: function(e, n) {
                    ...
                    r.isClosing || ((s = (s = !e && r.current && r.current.isComplete ? r.current.$slide.find("*:visible" + (n ? ":not(.fancybox-close-small)" : "")) : r.$refs.container.find("*:visible")).filter(o).filter((function() {
                        return "hidden" !== i(this).css("visibility") && !i(this).hasClass("disabled")
                    }))).length ? (a = s.index(t.activeElement), e && e.shiftKey ? (a < 0 || 0 == a) && (e.preventDefault(), s.eq(s.length - 1).trigger("focus")) : (a < 0 || a == s.length - 1) && (e && e.preventDefault(), s.eq(0).trigger("focus"))) : r.$refs.container.trigger("focus"))
                },
                activate: function() {
                    var e = this;
                ...
                close: function(e, t) {
                    ...
                    return !(u.isClosing || (u.isClosing = !0, !1 === u.trigger("beforeClose", e) ? (u.isClosing = !1, c((function() {
                        u.update()
                    })), 1) : (u.removeEvents(), a = p.$content, n = p.opts.animationEffect, s = i.isNumeric(t) ? t : n ? p.opts.animationDuration : 0, p.$slide.removeClass("fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"), !0 !== e ? i.fancybox.stop(p.$slide) : n = !1, p.$slide.siblings().trigger("onReset").remove(), s && u.$refs.container.removeClass("fancybox-is-open").addClass("fancybox-is-closing").css("transition-duration", s + "ms"), u.hideLoading(p), u.hideControls(!0), u.updateCursor(), "zoom" !== n || a && s && "image" === p.type && !u.isMoved() && !p.hasError && (d = u.getThumbPos(p)) || (n = "fade"), "zoom" === n ? (i.fancybox.stop(a), r = i.fancybox.getTranslate(a), l = {
                        top: r.top,
                        left: r.left,
                        ...
                        width: d.width,
                        height: d.height
                    }, o = p.opts.zoomOpacity, "auto" == o && (o = Math.abs(p.width / p.height - d.width / d.height) > .1), o && (d.opacity = 0), i.fancybox.setTranslate(a, l), h(a), i.fancybox.animate(a, d, s, f), 0) : (n && s ? i.fancybox.animate(p.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + n, s, f) : !0 === e ? setTimeout(f, s) : f(), 0))))
                },
                cleanUp: function(t) {
                    var n, s, a, r = this,
                        o = r.current.opts.$orig;
                    r.current.$slide.trigger("onReset"), r.$refs.container.empty().remove(), r.trigger("afterClose", t), r.current.opts.backFocus && (o && o.length && o.is(":visible") || (o = r.$trigger), o && o.length && (s = e.scrollX, a = e.scrollY, o.trigger("focus"), i("html, body").scrollTop(a).scrollLeft(s))), r.current = null, (n = i.fancybox.getInstance()) ? n.activate() : (i("body").removeClass("fancybox-active compensate-for-scrollbar"), i("#fancybox-style-noscroll").remove())
                },
                trigger: function(e, t) {
                    ...
                    "afterClose" !== e && a.$refs ? a.$refs.container.trigger(e + ".fb", s) : o.trigger(e + ".fb", s)
                },
                updateControls: function() {
                    var e = this,
                        ...
                        r = e.$refs.caption,
                        o = n.opts.caption;
                    n.$slide.trigger("refresh"), o && o.length ? (e.$caption = r, r.children().eq(0).html(o)) : e.$caption = null, e.hasHiddenControls || e.isIdle || e.showControls(), a.find("[data-fancybox-count]").html(e.group.length), a.find("[data-fancybox-index]").html(s + 1), a.find("[data-fancybox-prev]").prop("disabled", !n.opts.loop && s <= 0), a.find("[data-fancybox-next]").prop("disabled", !n.opts.loop && s >= e.group.length - 1), "image" === n.type ? a.find("[data-fancybox-zoom]").show().end().find("[data-fancybox-download]").attr("href", n.opts.image.src || n.src).show() : n.opts.toolbar && a.find("[data-fancybox-download],[data-fancybox-zoom]").hide(), i(t.activeElement).is(":hidden,[disabled]") && e.$refs.container.trigger("focus")
                },
            ...
            }, o.on("click.fb-start", "[data-fancybox]", s), o.on("click.fb-start", "[data-fancybox-trigger]", (function(e) {
    ...
    e(document).on("objectNeedsType.fb", (function(n, s, a) {
        ...
        r = e.extend(!0, {}, t, a.opts.media), e.each(r, (function(t, n) {
            if (l = p.match(n.matcher)) {
                ...
                return c = e.extend(!0, {}, n.params, a.opts[t], u), p = "function" === e.type(n.url) ? n.url.call(this, l, c, a) : i(n.url, l, c), o = "function" === e.type(n.thumb) ? n.thumb.call(this, l, c, a) : i(n.thumb, l), "youtube" === t ? p = p.replace(/&t=((\d+)m)?(\d+)s/, (function(e, t, i, n) {
...
function(e, t, i) {
    ...
    d.prototype.destroy = function() {
        ...
        var e, t, i, n, s, a, r = this,
            ...
            f = u.width,
            m = u.height;
        return s = f > o ? h + c : h, a = p + d, e = Math.max(0, .5 * o - .5 * f), t = Math.max(0, .5 * l - .5 * m), i = Math.min(o - f, .5 * o - .5 * f), n = Math.min(l - m, .5 * l - .5 * m), c > 0 && s > e && (s = e - 1 + Math.pow(-e + h + c, .8) || 0), c < 0 && s < i && (s = i + 1 - Math.pow(i - h - c, .8) || 0), d > 0 && a > t && (a = t - 1 + Math.pow(-t + p + d, .8) || 0), d < 0 && a < n && (a = n + 1 - Math.pow(n - p - d, .8) || 0), {
            top: a,
            left: s
        }
        ...
        var s = this.canvasWidth,
            a = this.canvasHeight;
        return i > s ? e = (e = e > 0 ? 0 : e) < s - i ? s - i : e : e = Math.max(0, s / 2 - i / 2), n > a ? t = (t = t > 0 ? 0 : t) < a - n ? a - n : t : t = Math.max(0, a / 2 - n / 2), {
            top: t,
            left: e
        }
        ...
        t.canTap = !1, t.newWidth = h, t.newHeight = p, t.contentLastPos = b, t.requestId && s(t.requestId), t.requestId = n((function() {
        ...
        var n = this,
            ...
            l = n.isZooming,
            c = n.isScrolling;
        if (n.endPoints = a(e), n.dMs = Math.max((new Date).getTime() - n.startTime, 1), n.$container.removeClass("fancybox-is-grabbing"), i(t).off(".fb.touch"), t.removeEventListener("scroll", n.onscroll, !0), n.requestId && (s(n.requestId), n.requestId = null), n.isSwiping = !1, n.isPanning = !1, n.isZooming = !1, n.isScrolling = !1, n.instance.isDragging = !1, n.canTap) return n.onTap(e);
        ...
        var n = this,
            ...
            o = "x" == e && a > 1 && (n.dMs > 130 && r > 10 || r > 50);
        n.sliderLastPos = null, "y" == e && !t && Math.abs(n.distanceY) > 50 ? (i.fancybox.animate(n.instance.current.$slide, {
            top: n.sliderStartPos.top + n.distanceY + 150 * n.velocityY,
            opacity: 0
        }, 200), s = n.instance.close(!0, 250)) : o && n.distanceX > 0 ? s = n.instance.previous(300) : o && n.distanceX < 0 && (s = n.instance.next(300)), !1 !== s || "x" != e && "y" != e || n.instance.centerSlide(200), n.$container.removeClass("fancybox-is-sliding")
        ...
        var e, t, n, s, a = this,
            ...
            o = a.newWidth,
            l = a.newHeight;
        a.contentLastPos && (e = a.contentLastPos.left, s = {
            ...
            scaleX: 1,
            scaleY: 1
        }, i.fancybox.setTranslate(a.$content, s), o < a.canvasWidth && l < a.canvasHeight ? a.instance.scaleToFit(150) : o > r.width || l > r.height ? a.instance.scaleToActual(a.centerPointStartX, a.centerPointStartY, 150) : (n = a.limitPosition(e, t, o, l), i.fancybox.animate(a.$content, n, 150)))
    ...
    t.extend(n.prototype, {
        ...
        create: function() {
            var e, n = this,
                ...
                a = n.opts.parentEl,
                r = [];
            n.$grid || (n.$grid = t('<div class="' + i + " " + i + "-" + n.opts.axis + '"></div>').appendTo(s.$refs.container.find(a).addBack().filter(a)), n.$grid.on("click", "a", (function() {
                s.jumpTo(t(this).attr("data-index"))
            }))), n.$list || (n.$list = t('<div class="' + i + '__list">').appendTo(n.$grid)), t.each(s.group, (function(t, i) {
        ...
        focus: function(e) {
            var t, i, n = this,
                s = n.$list,
                a = n.$grid;
            n.instance.current && (i = (t = s.children().removeClass("fancybox-thumbs-active").filter('[data-index="' + n.instance.current.index + '"]').addClass("fancybox-thumbs-active")).position(), "y" === n.opts.axis && (i.top < 0 || i.top > s.height() - t.outerHeight()) ? s.stop().animate({
...
function(e, t) {
    ...
    t.extend(!0, t.fancybox.defaults, {
        ...
        var e, i, n = t.fancybox.getInstance(),
            s = n.current || null;
        s && ("function" === t.type(s.opts.share.url) && (e = s.opts.share.url.apply(s, [n, s])), i = s.opts.share.tpl.replace(/\{\{media\}\}/g, "image" === s.type ? encodeURIComponent(s.src) : "").replace(/\{\{url\}\}/g, encodeURIComponent(e)).replace(/\{\{url_raw\}\}/g, function(e) {
            var t = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
